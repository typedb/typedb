...
//
//import static io.mindmaps.migration.base.util.MigratorTestUtil.getProperties;
//import static io.mindmaps.migration.base.util.MigratorTestUtil.getProperty;
//import static io.mindmaps.migration.base.util.MigratorTestUtil.getResource;
//import static io.mindmaps.migration.base.util.MigratorTestUtil.getResources;
...
//                "} ";
//
//        migrator.migrate(template, getFile("simple-schema/data.json"));
//
...
//
//        migrator.migrate(template, getFile("all-types/data.json"));
//
...
//        load(graph, getFile("string-or-object/schema.gql"));
//
//        String template = "\n" +
//                "$thing isa the-thing\n" +
...
//                "        else {<the-thing>} ;";
//
//        migrator.migrate(template, getFile("string-or-object/data"));
//
