...
public class QueryParserTest {
    ...
    public void testParseComputeClusterWithMembersThenSize() {
        ConnectedComponentQuery<?> expected = Graql.compute().cluster().in("movie", "person").members().clusterSize(10);
    ...
    public void testParseComputeClusterWithSizeThenMembers() {
        ConnectedComponentQuery<?> expected = Graql.compute().cluster().in("movie", "person").clusterSize(10).members();
