...
public class InsertQueryImplTest {
    ...
    public void insertQueriesWithTheSameVarsAndQueryAreEqual() {
        InsertQuery query1 = Queries.insert(vars1, match1, Optional.empty());
        InsertQuery query2 = Queries.insert(vars1, match1, Optional.empty());
    ...
    public void insertQueriesWithTheSameVarsAndGraphAreEqual() {
        ...
        InsertQuery query1 = Queries.insert(vars1, Optional.empty(), Optional.of(graph));
        InsertQuery query2 = Queries.insert(vars1, Optional.empty(), Optional.of(graph));
    ...
    public void insertQueriesWithDifferentMatchesAreDifferent() {
        InsertQuery query1 = Queries.insert(vars1, match1, Optional.empty());
        InsertQuery query2 = Queries.insert(vars1, match2, Optional.empty());
    ...
    public void insertQueriesWithDifferentGraphsAreDifferent() {
        ...
        InsertQuery query1 = Queries.insert(vars1, Optional.empty(), Optional.of(graph1));
        InsertQuery query2 = Queries.insert(vars2, Optional.empty(), Optional.of(graph2));
    ...
    public void insertQueriesWithDifferentVarsAreDifferent() {
        InsertQuery query1 = Queries.insert(vars1, match1, Optional.empty());
        InsertQuery query2 = Queries.insert(vars2, match1, Optional.empty());
