...
public class TxFactoryBuilderTest {
    ...
    private final static InputStream TEST_CONFIG_FILE = TxFactoryBuilderTest.class.getClassLoader().getResourceAsStream("ai/grakn/factory/inmemory-graph.properties");
