...
import static io.grakn.util.Schema.EdgeLabel.SHORTCUT;
import static io.grakn.util.Schema.EdgeProperty.FROM_ROLE;
import static io.grakn.util.Schema.EdgeProperty.RELATION_TYPE_ID;
import static io.grakn.util.Schema.EdgeProperty.TO_ROLE;
