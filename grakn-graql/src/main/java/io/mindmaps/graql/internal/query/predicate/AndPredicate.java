...
class AndPredicate extends AbstractValuePredicate {
    ...
    AndPredicate(ValuePredicateAdmin predicate1, ValuePredicateAdmin predicate2, ImmutableSet<Object> innerValues) {
        super(innerValues);
    ...
    public P<Object> getPredicate() {
        return predicate1.getPredicate().and(predicate2.getPredicate());
    }
