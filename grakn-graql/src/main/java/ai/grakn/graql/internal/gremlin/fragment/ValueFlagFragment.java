...
import static io.grakn.util.Schema.ConceptProperty.VALUE_BOOLEAN;
import static io.grakn.util.Schema.ConceptProperty.VALUE_DOUBLE;
import static io.grakn.util.Schema.ConceptProperty.VALUE_LONG;
import static io.grakn.util.Schema.ConceptProperty.VALUE_STRING;
