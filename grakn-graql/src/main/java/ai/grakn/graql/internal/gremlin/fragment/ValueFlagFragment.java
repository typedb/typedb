...
class ValueFlagFragment extends AbstractFragment {
    ...
    public void applyTraversal(GraphTraversal<Vertex, Vertex> traversal) {
        traversal.or(
                __.has(Schema.ConceptProperty.VALUE_STRING.name()),
                __.has(Schema.ConceptProperty.VALUE_LONG.name()),
                __.has(Schema.ConceptProperty.VALUE_DOUBLE.name()),
                __.has(Schema.ConceptProperty.VALUE_BOOLEAN.name())
        );
    }
