...
public class GraknTxTinkerFactoryTest {
    private final static InputStream TEST_CONFIG_FILE = GraknTxTinkerFactoryTest.class.getClassLoader().getResourceAsStream("grakn-graql/test/factory/inmemory-graph.properties");
