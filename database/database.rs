...
typedb_error! {
    pub DatabaseOpenError(component = "Database open", prefix = "DBO") {
        ...
        SyncForWrites(17, "Failed to sync database '{name}' for writes. In-memory allocators may collide with storage on the next allocation.", name: String, source: EncodingError),
    }
}
