...
impl ValueTypeID {
    ...
    const fn new(bytes: [u8; { ValueTypeID::LENGTH }]) -> Self {
...
macro_rules! value_type_functions {
    ($(
        ...
        pub(crate) const fn value_type_id(&self) -> ValueTypeID {
        ...
        pub(crate) fn from_value_type_id(value_type_id: ValueTypeID) -> Self {
