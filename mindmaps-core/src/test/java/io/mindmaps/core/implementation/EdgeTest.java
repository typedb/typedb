...
public class EdgeTest {
    ...
    private AbstractMindmapsTransaction mindmapsTransaction;
    ...
    @Before
    public void setUp(){
        mindmapsTransaction = (AbstractMindmapsTransaction) MindmapsTestGraphFactory.newEmptyGraph().newTransaction();
