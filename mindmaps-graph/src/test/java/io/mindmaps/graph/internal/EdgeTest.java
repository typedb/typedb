...
public class EdgeTest {
    ...
    public void setUp(){
        ...
        Edge tinkerEdge = (Edge) mindmapsGraph.getTinkerTraversal().V().has(Schema.ConceptProperty.ITEM_IDENTIFIER.name(), entity.getId()).outE().next();
    ...
    public void testEquals(){
        ...
        Edge tinkerEdge = (Edge) mindmapsGraph.getTinkerTraversal().V().has(Schema.ConceptProperty.ITEM_IDENTIFIER.name(), entity2.getId()).outE().next();
