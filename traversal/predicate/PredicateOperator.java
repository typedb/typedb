...
public abstract class PredicateOperator {
    ...
    public static abstract class SubString extends PredicateOperator {
        ...
        abstract boolean apply(String vertexValue, GraphTraversal.Unrestricted.Parameters.Value predicateValue);
        ...
        private static final SubString CONTAINS = new SubString(TypeQLToken.Predicate.SubString.CONTAINS) {
            @Override
            boolean apply(String vertexValue, GraphTraversal.Unrestricted.Parameters.Value predicateValue) {
