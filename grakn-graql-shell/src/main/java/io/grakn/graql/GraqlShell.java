...
import static io.grakn.util.REST.RemoteShell.ACTION;
import static io.grakn.util.REST.RemoteShell.ACTION_AUTOCOMPLETE;
import static io.grakn.util.REST.RemoteShell.ACTION_COMMIT;
import static io.grakn.util.REST.RemoteShell.ACTION_ERROR;
import static io.grakn.util.REST.RemoteShell.ACTION_KEYSPACE;
import static io.grakn.util.REST.RemoteShell.ACTION_PING;
import static io.grakn.util.REST.RemoteShell.ACTION_QUERY;
import static io.grakn.util.REST.RemoteShell.ACTION_QUERY_ABORT;
import static io.grakn.util.REST.RemoteShell.ACTION_QUERY_END;
import static io.grakn.util.REST.RemoteShell.ACTION_ROLLBACK;
import static io.grakn.util.REST.RemoteShell.AUTOCOMPLETE_CURSOR;
import static io.grakn.util.REST.RemoteShell.ERROR;
import static io.grakn.util.REST.RemoteShell.KEYSPACE;
import static io.grakn.util.REST.RemoteShell.QUERY;
import static io.grakn.util.REST.RemoteShell.QUERY_RESULT;
import static io.grakn.util.REST.WebPath.IMPORT_DATA_URI;
import static io.grakn.util.REST.WebPath.REMOTE_SHELL_URI;
