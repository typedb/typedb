...
public abstract class ConjunctionController<
    ...
    protected abstract static class Processor<PROCESSOR extends Processor<PROCESSOR>>
        ...
        Processor(Driver<PROCESSOR> driver,
            ...
            this.bounds = bounds;
            this.plan = plan;
            context.perfCounters().add(ReasonerPerfCounters.Key.COUNT_CONJUNCTION_PROCESSORS, 1);
        }
        ...
        public class CompoundStream extends TransformationStream<ConceptMap, ConceptMap> {
            ...
            CompoundStream(AbstractProcessor<?, ?, ?, ?> processor, List<Resolvable<?>> plan,
                ...
                processor().context().perfCounters().add(ReasonerPerfCounters.Key.COUNT_COMPOUND_STREAMS, 1);
            }
