...
public class ConcludableTest {
    ...
    public void test_conjunction_only_isa_is_built() {
        ...
        Set<Concludable<?>> concludables = Concludable.of(parseConjunction(conjunction));
    ...
    public void test_isa_owner_has_value() {
        ...
        Concludable.Isa isaConcludable = new Concludable.Isa(isaConstraint, conjunction.variables());
    ...
    public void test_has_concludable_gathers_owner_type_label() {
        ...
        Concludable.Has hasConcludable = new Concludable.Has(hasConstraint, contextVariables);
    ...
    public void test_type_label_constraint_passed_to_concludable() {
        ...
        Concludable.Relation relationConcludable = new Concludable.Relation(relationConstraint, contextVariables);
