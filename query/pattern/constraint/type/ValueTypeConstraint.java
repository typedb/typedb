...
public class ValueTypeConstraint extends TypeConstraint {
    ...
    private ValueTypeConstraint(final TypeVariable owner, final AttributeType.ValueType valueType) {
        super(owner);
    ...
    public static ValueTypeConstraint of(final TypeVariable owner,
        ...
        return new ValueTypeConstraint(owner, AttributeType.ValueType.of(constraint.valueType()));
    }
