...
// use crate::{
//     batch::MaybeOwnedRow,
//     pipeline::{PipelineContext, PipelineError, StageAPI, },
// };
//
...
//
//     fn store_incoming_row_into(&self, incoming: &MaybeOwnedRow<'_>, stored_row: &mut Box<[VariableValue<'static>]>) {
...
//         Executor: AccumulatingStageAPI<Snapshot>
// {
//     type OutputIterator = AccumulatedRowIterator<Snapshot>;
//
//     fn into_iterator(mut self) -> Result<Self::OutputIterator, PipelineError> {
...
//             self.next_index += 1;
//             Some(Ok(MaybeOwnedRow::new(row, *multiplicity)))
//         } else {
//             None
//         }
//     }
