...
In the [Basic Ontology documentation](../building-a-schema/basic-schema.html) we introduced a simple schema built using Graql.
...
In the [Hierarchical Ontology documentation](../building-a-schema/hierarchical-schema.html), we discussed how it is possible to create more expressive ontologies by creating a type hierarchy.
