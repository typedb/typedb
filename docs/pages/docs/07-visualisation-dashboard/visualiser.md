...
1. Submit the query by pressing '>' (or *Enter*) to visualise the knowledge graph. The two people in question (Susan Dudley and Barbara Herchelroth) should be shown.
