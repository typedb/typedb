...
Having loaded the schema, the next steps are to populate the knowledge graph by migrating data into Grakn, using Graql templates. There are separate templates for each entity. First, for the books:
