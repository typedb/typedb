...
from grakn.service.Session.autogenerated import Session_pb2 as transaction_messages, Concept_pb2 as concept_messages 
...
class RequestBuilder(object):
    ...
    def concept_method_req_to_tx_req(concept_id, grpc_concept_method_req):
        print("Type of concept method: {0}".format(type(grpc_concept_method_req)))
    ...
    def put_relationship_type(label):
        put_relationship_type_req = transaction_messages.Tranaction.PutRelationshipType.Req()
