...
#[tokio::test]
async fn test_read_expressions() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/language/expression.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/language/expression.feature";
