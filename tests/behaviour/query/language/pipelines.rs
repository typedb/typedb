...
async fn test() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../vaticle_typedb_behaviour/query/language/pipelines.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/vaticle_typedb_behaviour/query/language/pipelines.feature";
