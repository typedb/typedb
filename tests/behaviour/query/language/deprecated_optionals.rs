...
#[tokio::test]
async fn test_deprecated_optionals() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour+/query/language/deprecated_optionals.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour+/query/language/deprecated_optionals.feature";
