...
async fn test_read_match() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/language/match.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/language/match.feature";
