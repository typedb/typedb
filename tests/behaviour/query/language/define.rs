...
#[tokio::test]
async fn test_definable_define() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/language/define.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/language/define.feature";
