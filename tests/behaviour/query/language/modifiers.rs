...
async fn test_read_modifiers() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/language/modifiers.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/language/modifiers.feature";
