...
#[tokio::test]
async fn test_functions_definition() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/functions/definition.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/functions/definition.feature";
