...
#[tokio::test]
async fn test_functions_structure() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/functions/structure.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/functions/structure.feature";
