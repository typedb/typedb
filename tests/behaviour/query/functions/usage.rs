...
async fn test_functions_usage() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/functions/usage.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/functions/usage.feature";
