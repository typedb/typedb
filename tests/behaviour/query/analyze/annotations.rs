...
#[tokio::test]
async fn test_analyze_annotations() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/query/analyze/annotations.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/query/analyze/annotations.feature";
