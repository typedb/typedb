...
#[cucumber::when("connection delete database(s):")]
...
#[cucumber::when("connection delete database(s) in parallel:")]
...
#[cucumber::then("connection has database(s):")]
...
#[cucumber::then("connection does not have database(s):")]
