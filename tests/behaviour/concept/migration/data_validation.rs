...
async fn test_data_validation() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour+/concept/migration/data-validation.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour+/concept/migration/data-validation.feature";
