...
async fn test_attribute_type() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/concept/type/attributetype.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/concept/type/attributetype.feature";
