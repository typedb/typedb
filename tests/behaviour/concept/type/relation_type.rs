...
async fn test_relation_type() {
    ...
    #[cfg(feature = "bazel")]
    let path = "../typedb_behaviour/concept/type/relationtype.feature";

    #[cfg(not(feature = "bazel"))]
    let path = "bazel-typedb/external/typedb_behaviour/concept/type/relationtype.feature";
