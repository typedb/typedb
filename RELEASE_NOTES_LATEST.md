...
[Distributions for 3.8.3-rc0](https://cloudsmith.io/~typedb/repos/public-release/packages/?q=name%3A%5Etypedb-all+version%3A3.8.3-rc0)

**Pull the Docker image:**

```docker pull typedb/typedb:3.8.3-rc0```
...
## Other Improvements
- **DEBUG OOM in recovery: print record sizes**
  
  This commit is to be reverted before full release
