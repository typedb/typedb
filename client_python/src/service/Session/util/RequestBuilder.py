...
def get_tx_req():
    return transaction_messages.Transaction.Req()
...
class RequestBuilder(object):
    ...
    def concept_method_req_to_tx_req(concept_id, grpc_concept_method_req):
            ...
            return get_tx_req().conceptMethod_req.CopyFrom(concept_method_req)
    ...
    def open_tx(keyspace, tx_type):
        ...
        return get_tx_req().open_req.CopyFrom(open_request)
    ...
    def query(query, options=None):
        ...
        return get_tx_req().query_req.CopyFrom(query_message)

    @staticmethod
    def commit():
        commit_req = transaction_messages.Transaction.Commit.Req()
        return get_tx_req().commit_req.CopyFrom(commit_req)
    ...
    def get_concept(concept_id):
        ...
        return get_tx_req().getConcept_req.CopyFrom(get_concept_req)
    ...
    def get_schema_concept(label):
        ...
        return get_tx_req().getConcept_req.CopyFrom(get_schema_concept_req)
    ...
    def get_attributes_by_value(value, datatype: enums.DataType):
        ...
        return get_tx_req().getAttribute_req.CopyFrom(get_attrs_req)
