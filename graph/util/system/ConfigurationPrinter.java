...
import static grakn.core.graph.util.encoding.StringEncoding.UTF8_ENCODING;
...
//    private static final String TABLE_HEADER_LINES = "[role=\"tss-config-table\",cols=\"2,3,1,1,1\",options=\"header\",width=\"100%\"]\n|=====\n| Name | Description | Datatype | Default Value | Mutability";
    ...
    public static void main(String args[]) throws IOException, ReflectiveOperationException {
        ...
        ConfigNamespace root = stringToNamespace(args[0]);
        PrintStream stream = new PrintStream(new FileOutputStream(args[1]), false, UTF8_ENCODING);
