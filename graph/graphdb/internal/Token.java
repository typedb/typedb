...
public class Token {
    ...
    public static void verifyName(String name) {
        Preconditions.checkArgument(name.indexOf(org.janusgraph.graphdb.internal.Token.SEPARATOR_CHAR) < 0,
                "Name can not contains reserved character %s: %s", org.janusgraph.graphdb.internal.Token.SEPARATOR_CHAR, name);
    }
