...
public interface IndexProvider extends IndexInformation {
    ...
    static void checkKeyValidity(String key) {
        Preconditions.checkArgument(!StringUtils.containsAny(key, new char[]{ org.janusgraph.diskstorage.indexing.IndexProvider.REPLACEMENT_CHAR }),
            "Invalid key name containing reserved character %c provided: %s", org.janusgraph.diskstorage.indexing.IndexProvider.REPLACEMENT_CHAR, key);
    }
