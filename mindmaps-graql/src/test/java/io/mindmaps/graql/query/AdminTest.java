...
public class AdminTest {
    ...
    public void testDefaultGetSelectedNamesInQuery() {
        MatchQueryMap query = qb.match(var("x").isa(var("y")));
    ...
    public void testExplicitGetSelectedNamesInQuery() {
        MatchQueryMap query = qb.match(var("x").isa(var("y"))).select("x");
    ...
    public void testGetPatternInQuery() {
        MatchQueryMap query = qb.match(var("x").isa("movie"), var("x").value("Bob"));
