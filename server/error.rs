...
use crate::{authentication::token_manager::TokenManagerError, state::LocalServerStateError};
...
typedb_error! {
    pub ServerOpenError(component = "Server open", prefix = "SRO") {
        ...
        ServerState(25, "Invalid server state.", typedb_source: Box<LocalServerStateError>),
    }
}
