 ...
 */
abstract class VarPatternBase extends AbstractVarPattern {

    protected final Logger LOG = LoggerFactory.getLogger(VarPatternBase.class);
    ...
    public String toString() {
        ...
        if (innerVars.stream().anyMatch(VarPatternBase::invalidInnerVariable)) {
