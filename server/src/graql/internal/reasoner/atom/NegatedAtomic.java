...
public abstract class NegatedAtomic implements Atomic {
    ...
    @Override
    public Atomic negate() { return inner(); }
    ...
    @Override
    public Var getVarName() { return inner().getVarName(); }

    @Override
    public VarPattern getPattern() { return inner().getPattern(); }
    ...
    @Override
    public Set<Var> getVarNames() { return inner().getVarNames(); }
