...
public class ReasonerAtomicQuery extends ReasonerQueryImpl {
    ...
    private final grakn.core.graql.reasoner.atom.Atom atom;
    ...
    ReasonerAtomicQuery(grakn.core.graql.reasoner.atom.Atom at) {
        super(at);
        this.atom = Iterables.getOnlyElement(selectAtoms()::iterator);
    }
    ...
    @Override
    public String toString(){ return getAtoms(grakn.core.graql.reasoner.atom.Atom.class).map(Atomic::toString).collect(Collectors.joining(", "));}
     ...
     */
    public grakn.core.graql.reasoner.atom.Atom getAtom() {
        return atom;
    }
    ...
    @Override
    public Iterator<grakn.core.graql.reasoner.state.ResolutionStateImpl> innerStateIterator(grakn.core.graql.reasoner.state.AnswerPropagatorStateImpl parent, Set<ReasonerAtomicQuery> visitedSubGoals) {
        ...
        Iterator<grakn.core.graql.reasoner.state.ResolutionStateImpl> dbCompletionIterator =
        ...
        Iterator<grakn.core.graql.reasoner.state.ResolutionStateImpl> subGoalIterator = !doNotResolveFurther?
     ...
     */
    private Iterator<grakn.core.graql.reasoner.state.ResolutionStateImpl> ruleStateIterator(grakn.core.graql.reasoner.state.AnswerPropagatorStateImpl parent, Set<ReasonerAtomicQuery> visitedSubGoals) {
        return RuleUtils
