...
public class ReasonerQueries {
     ...
     */
    public static CompositeQuery composite(Conjunction<Pattern> pattern, Transaction tx){
     ...
     */
    public static CompositeQuery composite(ReasonerQueryImpl conj, Set<ResolvableQuery> comp, Transaction tx){
     ...
     */
    public static ResolvableQuery resolvable(Conjunction<Pattern> pattern, Transaction tx){
    ...
    public static ReasonerQueryImpl createWithoutRoleInference(Conjunction<Statement> pattern, Transaction tx) {
     ...
     */
    public static ReasonerQueryImpl create(Conjunction<Statement> pattern, Transaction tx) {
     ...
     */
    public static ReasonerQueryImpl create(Set<Atomic> as, Transaction tx){
     ...
     */
    public static ReasonerQueryImpl create(List<grakn.core.graql.reasoner.atom.Atom> as, Transaction tx){
     ...
     */
    public static ReasonerAtomicQuery atomic(Conjunction<Statement> pattern, Transaction tx){
     ...
     */
    public static ReasonerAtomicQuery atomic(grakn.core.graql.reasoner.atom.Atom atom){
     ...
     * @return reasoner query defined by the provided set of atomics
     */
    public static ReasonerAtomicQuery atomic(Set<Atomic> as, Transaction tx){
