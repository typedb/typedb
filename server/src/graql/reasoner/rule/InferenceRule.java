...
public class InferenceRule {
    ...
    private grakn.core.graql.reasoner.atom.Atom conclusionAtom = null;
    ...
    long resolutionPriority(){
        if (priority == Long.MAX_VALUE) {
            ...
            boolean bodyRuleResolvable = getBody().getAtoms(grakn.core.graql.reasoner.atom.Atom.class)
                    .map(grakn.core.graql.reasoner.atom.Atom::getSchemaConcept)
     ...
     */
    public boolean requiresMaterialisation(grakn.core.graql.reasoner.atom.Atom parentAtom){
     ...
     */
    public grakn.core.graql.reasoner.atom.Atom getRuleConclusionAtom() {
        if (conclusionAtom == null) {
            conclusionAtom = getCombinedQuery().getAtoms(grakn.core.graql.reasoner.atom.Atom.class)
     ...
     */
    private InferenceRule propagateConstraints(grakn.core.graql.reasoner.atom.Atom parentAtom, Unifier unifier){
        if (!parentAtom.isRelation() && !parentAtom.isResource()) return this;
        grakn.core.graql.reasoner.atom.Atom headAtom = head.getAtom();
    ...
    public boolean appendsRolePlayers(){
        grakn.core.graql.reasoner.atom.Atom headAtom = getHead().getAtom();
    ...
    private InferenceRule rewriteHeadToRelation(grakn.core.graql.reasoner.atom.Atom parentAtom){
    ...
    private InferenceRule rewriteVariables(grakn.core.graql.reasoner.atom.Atom parentAtom){
     ...
     */
    public InferenceRule rewrite(grakn.core.graql.reasoner.atom.Atom parentAtom){
        return this
                .rewriteBodyAtoms()
     ...
     */
    public MultiUnifier getMultiUnifier(grakn.core.graql.reasoner.atom.Atom parentAtom) {
        grakn.core.graql.reasoner.atom.Atom childAtom = getRuleConclusionAtom();
        ...
        //case of match all atom (atom without type)
            ...
            grakn.core.graql.reasoner.atom.Atom extendedParent = parentAtom
     ...
     */
    public grakn.core.graql.reasoner.state.ResolutionStateImpl subGoal(grakn.core.graql.reasoner.atom.Atom parentAtom, Unifier ruleUnifier, grakn.core.graql.reasoner.state.AnswerPropagatorStateImpl parent, Set<ReasonerAtomicQuery> visitedSubGoals){
