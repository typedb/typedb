...
import kb.reasoner.state.AnswerPropagatorState;
 ...
 *
 */
public abstract class AnswerPropagatorStateImpl<Q extends ResolvableQuery> extends ResolutionState implements AnswerPropagatorState {
    ...
    AnswerPropagatorStateImpl(Q query, ConceptMap sub, Unifier u, grakn.core.graql.reasoner.state.AnswerPropagatorStateImpl parent, Set<ReasonerAtomicQuery> subGoals) {
        super(sub, parent);
        this.query = query;
        this.unifier = u;
