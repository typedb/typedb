...
import kb.reasoner.state.ResolutionState;
 ...
 *
 */
public abstract class ResolutionStateImpl implements ResolutionState {

    private final ConceptMap sub;
    private final AnswerPropagatorStateImpl parentState;

    ResolutionStateImpl(ConceptMap sub, AnswerPropagatorState parent){
        this.sub = sub;
     ...
     */
    public abstract grakn.core.graql.reasoner.state.ResolutionStateImpl generateChildState();
