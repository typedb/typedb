...
public final class ResolutionPlan {
    ...
    private final ImmutableList<grakn.core.graql.reasoner.atom.Atom> plan;
     ...
     */
    public ImmutableList<grakn.core.graql.reasoner.atom.Atom> plan(){ return plan;}
    ...
    private void validatePlan() {
        ...
        Iterator<grakn.core.graql.reasoner.atom.Atom> iterator = plan.iterator();
