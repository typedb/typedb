...
public abstract class Atom extends AtomicBase {
    ...
    public boolean subsumes(Atomic atomic) {
        ...
        grakn.core.graql.reasoner.atom.Atom parent = (grakn.core.graql.reasoner.atom.Atom) atomic;
     ...
     */
    public boolean isUnifiableWith(grakn.core.graql.reasoner.atom.Atom atom) {
    ...
    public boolean isDisconnected() {
        return isSelectable()
                && getParentQuery().getAtoms(grakn.core.graql.reasoner.atom.Atom.class)
    ...
    protected abstract boolean isRuleApplicableViaAtom(grakn.core.graql.reasoner.atom.Atom headAtom);
    ...
    @Override
    public grakn.core.graql.reasoner.atom.Atom inferTypes() { return inferTypes(new ConceptMap()); }

    @Override
    public grakn.core.graql.reasoner.atom.Atom inferTypes(ConceptMap sub) { return this; }
     ...
     */
    public List<grakn.core.graql.reasoner.atom.Atom> atomOptions(ConceptMap sub) { return Lists.newArrayList(inferTypes(sub));}

    /**
     * @param type to be added to this Atom
     * @return new Atom with specified type
     */
    public grakn.core.graql.reasoner.atom.Atom addType(SchemaConcept type) { return this;}
     ...
     */
    public Set<grakn.core.graql.reasoner.atom.Atom> rewriteToAtoms() { return Sets.newHashSet(this);}
     ...
     */
    public grakn.core.graql.reasoner.atom.Atom rewriteWithTypeVariable(grakn.core.graql.reasoner.atom.Atom parentAtom) {
     ...
     * @return rewritten atom
     */
    public abstract grakn.core.graql.reasoner.atom.Atom rewriteToUserDefined(grakn.core.graql.reasoner.atom.Atom parentAtom);


    public abstract grakn.core.graql.reasoner.atom.Atom rewriteWithTypeVariable();
     ...
     * @return rewritten atom
     */
    public grakn.core.graql.reasoner.atom.Atom rewriteWithRelationVariable() { return this;}
     ...
     */
    @Nullable
    public abstract Unifier getUnifier(grakn.core.graql.reasoner.atom.Atom parentAtom, UnifierType unifierType);
     ...
     */
    protected boolean isPredicateCompatible(grakn.core.graql.reasoner.atom.Atom parentAtom, Unifier unifier, UnifierType unifierType){
     ...
     * @return multiunifier
     */
    public MultiUnifier getMultiUnifier(grakn.core.graql.reasoner.atom.Atom parentAtom, UnifierType unifierType) {
     ...
     */
    public SemanticDifference semanticDifference(grakn.core.graql.reasoner.atom.Atom childAtom, Unifier unifier) {
