...
import grakn.core.graql.reasoner.atom.binary.AutoValue_AttributeAtom;
...
public abstract class AttributeAtom extends Binary{
    ...
    public Set<String> validateAsRuleHead(Rule rule){
        ...
        if (getMultiPredicate().isEmpty()){
            boolean predicateBound = getParentQuery().getAtoms(grakn.core.graql.reasoner.atom.Atom.class)
    ...
    @Override
    public Unifier getUnifier(grakn.core.graql.reasoner.atom.Atom parentAtom, UnifierType unifierType) {
     ...
     */
    private AttributeAtom rewriteWithRelationVariable(grakn.core.graql.reasoner.atom.Atom parentAtom){
    ...
    @Override
    public grakn.core.graql.reasoner.atom.Atom rewriteWithTypeVariable() {
