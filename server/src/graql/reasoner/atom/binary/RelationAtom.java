...
import grakn.core.graql.reasoner.atom.binary.AutoValue_RelationAtom;
...
import static grakn.core.kb.ConceptUtils.bottom;
import static grakn.core.kb.ConceptUtils.top;
...
public abstract class RelationAtom extends IsaAtomBase {
    ...
    @Override
    public Set<grakn.core.graql.reasoner.atom.Atom> rewriteToAtoms(){
    ...
    @Override
    public boolean isRuleApplicableViaAtom(grakn.core.graql.reasoner.atom.Atom ruleAtom) {
    ...
    @Override
    public List<grakn.core.graql.reasoner.atom.Atom> atomOptions(ConceptMap sub) {
        return this.inferPossibleTypes(sub).stream()
                ...
                .sorted(Comparator.comparing(grakn.core.graql.reasoner.atom.Atom::isRuleResolvable))
    ...
    @Override
    public Unifier getUnifier(grakn.core.graql.reasoner.atom.Atom pAtom, UnifierType unifierType){
    ...
    @Override
    public SemanticDifference semanticDifference(grakn.core.graql.reasoner.atom.Atom child, Unifier unifier) {
     ...
     */
    private RelationAtom rewriteWithVariableRoles(grakn.core.graql.reasoner.atom.Atom parentAtom){
     ...
     */
    private RelationAtom rewriteWithRelationVariable(grakn.core.graql.reasoner.atom.Atom parentAtom){
    ...
    @Override
    public grakn.core.graql.reasoner.atom.Atom rewriteToUserDefined(grakn.core.graql.reasoner.atom.Atom parentAtom){
        return this
