...
import static grakn.core.commons.util.ErrorMessage.INSERT_ABSTRACT_NOT_TYPE;
import static grakn.core.commons.util.ErrorMessage.INSERT_RECURSIVE;
import static grakn.core.commons.util.ErrorMessage.INSERT_UNDEFINED_VARIABLE;
import static grakn.core.commons.util.ErrorMessage.INVALID_COMPUTE_ARGUMENT;
import static grakn.core.commons.util.ErrorMessage.INVALID_COMPUTE_CONDITION;
import static grakn.core.commons.util.ErrorMessage.INVALID_COMPUTE_METHOD;
import static grakn.core.commons.util.ErrorMessage.INVALID_COMPUTE_METHOD_ALGORITHM;
import static grakn.core.commons.util.ErrorMessage.INVALID_VALUE;
import static grakn.core.commons.util.ErrorMessage.MISSING_COMPUTE_CONDITION;
import static grakn.core.commons.util.ErrorMessage.NEGATIVE_OFFSET;
import static grakn.core.commons.util.ErrorMessage.NON_POSITIVE_LIMIT;
import static grakn.core.commons.util.ErrorMessage.UNEXPECTED_RESULT;
import static grakn.core.commons.util.ErrorMessage.VARIABLE_NOT_IN_QUERY;
