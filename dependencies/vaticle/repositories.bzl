...
def vaticle_typeql():
    git_repository(
        ...
        commit = "4bd1275acc260125d1281fbed5c1c7e22a8ae64e",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typeql
    )
...
#    )
    git_repository(
        ...
        commit = "551f2108b7fa6c2a34bfdd30763fe42e0a8cf2b2", # sync-marker: do not remove this comment, this is used for sync-dependencies by @vaticle_typedb_behaviour
    )
