...
def typeql():
    git_repository(
        ...
        commit = "d11c7195c57a0e8c6a3034810ac33761ee2ca299",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_driver
    )
...
def typedb_protocol():
    git_repository(
        ...
        commit = "0880bfc7f87932d95c6173f7328a119724537d08",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_protocol
    )
