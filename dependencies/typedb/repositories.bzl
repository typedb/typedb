...
def typeql():
    git_repository(
        ...
        commit = "e6ad0edce7713f79bb146743a83711f7196337d2",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typeql
    )
...
def typedb_behaviour():
    git_repository(
        ...
        commit = "b1dba2141c237c211a2f4a598c8ecafd33dc901a",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_behaviour
    )
