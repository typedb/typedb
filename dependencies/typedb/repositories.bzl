...
def typedb_bazel_distribution():
    git_repository(
        ...
        commit = "770f104d1851178ff4c0329c045701d27f20f697",
    )
...
def typeql():
    git_repository(
        ...
        tag = "3.0.5",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typeql
    )
...
def typedb_behaviour():
    git_repository(
        ...
        commit = "e9db254ca5c3f10685b1137ae98df879ca207905",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_behaviour
    )
