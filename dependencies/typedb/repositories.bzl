...
def typeql():
    git_repository(
        ...
        commit = "0a0cac51ccb75b2c5f31da53bd31629eff60cacc",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typeql
    )
...
def typedb_behaviour():
    ...
    git_repository(
        ...
        commit = "dd418dc7e03e464c7b8baf23be0b46aadcd7702a",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_behaviour
    )
