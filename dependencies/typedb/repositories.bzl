...
def typeql():
    ...
    git_repository(
        ...
        commit = "0e12f4aeb3f95fccbf7bdd8c7fda2d1a5e916825",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_driver
    )
...
def typedb_protocol():
    ...
    git_repository(
        ...
        commit = "8e5d232c7e290a076531fe750d04955f6a48ba5b",  # sync-marker: do not remove this comment, this is used for sync-dependencies by @typedb_protocol
    )
