...
def graknlabs_common():
    git_repository(
        ...
        commit = "615875848e3abf3a68b3ad93e9b82a0d6bfb1862" # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_common
    )
...
def graknlabs_protocol():
    git_repository(
        ...
        commit = "49b4b5c34d3b01fd6957f3cc19c273af703210c1", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_protocol
    )
...
def graknlabs_verification():
    git_repository(
        ...
        commit = "39a47b07798fc090c152e7d22034e80df02ee638"
    )
