...
def graknlabs_dependencies():
    git_repository(
        ...
        commit = "c0fd9b157aa891555b5b1aa524624c9f143a4006", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_dependencies
    )
...
def graknlabs_common():
    git_repository(
        ...
        commit = "92abffcf7b1bc9cdd28b66d740e9645df9f43d70" # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_common
    )
...
def graknlabs_graql():
    git_repository(
        ...
        commit = "57f2851ce0afc228344650ab8af59f889dd4262d" # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_graql
    )
