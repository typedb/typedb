...
def graknlabs_common():
    git_repository(
        ...
        commit = "ee8103fd9871d75feea3b0edec3e8c283accae0b", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_common
    )
...
def graknlabs_graql():
     git_repository(
         ...
         commit = "c16c5ac3c0a5ceef421d2afc49e31b553a383735", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_graql
     )
...
def graknlabs_console():
    git_repository(
        ...
        commit = "05aef910c981e731ddbddf21e2a8ff1cbd29bfde"
    )
