...
def graknlabs_common():
    git_repository(
        ...
        commit = "2068be9c04f54da7a3bf9c7323b276e1e50cc1b3", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_common
    )
...
def graknlabs_graql():
     git_repository(
         ...
         commit = "db273a8fa344ea971725526e0f3d584f1c2feff4", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_graql
     )
...
def graknlabs_protocol():
    git_repository(
        ...
        commit = "dcfc336603dc7285e8c27636c3048d6554616312", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_protocol
    )
