...
def graknlabs_build_tools():
    # TODO(lolski): revert to graknlabs
    git_repository(
        name = "graknlabs_build_tools",
        remote = "https://github.com/lolski/build-tools",
        commit = "740917224fd0421c5e5bba7cd944b8a0963feafb", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_build_tools
    )
...
def graknlabs_graql():
     git_repository(
         ...
         commit = "8caa85e28eee2ed39f8e4892a00ab8ee5682e579", # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_graql
     )
