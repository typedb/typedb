...
pub enum SchemaValidationError {
    ...
    KeyDoesNotNarrowInheritedCardinality(Label<'static>, Label<'static>, Label<'static>, Label<'static>, AnnotationCardinality),
...
impl Error for SchemaValidationError {
    fn source(&self) -> Option<&(dyn Error + 'static)> {
        match self {
            ...
            Self::SummarizedCardinalityOfCapabilitiesOverridingSingleCapabilityOverflowsConstraint(_, _, _, _, _, _) => None,
