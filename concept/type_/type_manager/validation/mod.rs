...
pub enum SchemaValidationError {
    ...
    CannotDeleteAttributeTypeWithExistingOwns(Label<'static>),
    CannotDeleteRoleTypeWithExistingPlays(Label<'static>),
...
impl Error for SchemaValidationError {
    fn source(&self) -> Option<&(dyn Error + 'static)> {
        match self {
            ...
            Self::CannotDeleteAttributeTypeWithExistingOwns(_) => None,
            Self::CannotDeleteRoleTypeWithExistingPlays(_) => None,
