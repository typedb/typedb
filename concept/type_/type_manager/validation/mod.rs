...
typedb_error!(
    pub SchemaValidationError(component = "Schema validation", prefix = "SVL") {
        ...
        CannotUnsetInheritedOwns(37, "Cannot unset inherited from '{supertype}' 'owns {attribute_type}' constraint for '{subtype}'.", subtype: Label, supertype: Label, attribute_type: Label),
        CannotUnsetInheritedPlays(38, "Cannot unset inherited from '{supertype}' 'plays {role_type}' constraint for '{subtype}'.", subtype: Label, supertype: Label, role_type: Label),
        CannotUnsetInheritedValueType(39, "Cannot unset inherited from '{supertype}' value type '{value_type}' for '{subtype}'.", subtype: Label, supertype: Label, value_type: ValueType),
