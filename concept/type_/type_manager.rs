...
impl TypeManager {
    ...
    pub(crate) fn get_relation_type_relates_declared(
        ...
        if let Some(cache) = &self.type_cache {
            ...
            let relates = TypeReader::get_implemented_interfaces_declared::<Relates<'static>>(snapshot, relation_type.clone())?;
...
impl TypeManager {
    ...
    pub(crate) fn delete_relation_type(
        ...
        let declared_relates = TypeReader::get_implemented_interfaces::<Relates<'static>>(snapshot, relation_type.clone())?;
    ...
    pub(crate) fn set_annotation_range(
        ...
        // TODO: Verify that there is no range on subtypes (for schema validation!)
    ...
    pub(crate) fn set_annotation_values(
        ...
        // TODO: Verify that there is no values on subtypes (for schema validation!)
    ...
    pub(crate) fn set_owns_annotation_values(
        ...
        // TODO: Verify that there is no values on subtypes (schema validation only)
