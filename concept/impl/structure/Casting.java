...
package concept.impl.structure;
...
import concept.impl.ConceptCacheLine;
...
public class Casting {
    ...
    private final ConceptCacheLine<Role> cachedRole = new ConceptCacheLine<>(() -> conceptManager().getSchemaConcept(LabelId.of(edge().property(Schema.EdgeProperty.ROLE_LABEL_ID))));
    private final ConceptCacheLine<Thing> cachedInstance = new ConceptCacheLine<>(() -> conceptManager().buildConcept(edge().target()));
    private final ConceptCacheLine<Relation> cachedRelation = new ConceptCacheLine<>(() -> conceptManager().buildConcept(edge().source()));
