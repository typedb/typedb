...
public class FactoryBuilder {
    ...
    public static TxFactory<?> getFactory(GraknSessionImpl session, boolean isComputerFactory){
        try{
    ...
    */
    private static TxFactory<?> getFactory(String factoryType, GraknSessionImpl session){
     ...
     */
    private static synchronized TxFactory<?> newFactory(String factoryType, GraknSessionImpl session){
        TxFactory<?> txFactory;
        try {
            txFactory = (TxFactory<?>) Class.forName(factoryType)
                    .getDeclaredConstructor(GraknSessionImpl.class)
                    .newInstance(session);
