...
public class DashboardController {
    ...
    public DashboardController(EngineGraknGraphFactory factory, Service spark){
        ...
        spark.get(REST.WebPath.Dashboard.TYPES,         this::typesOfConcept);
        spark.get(REST.WebPath.Dashboard.EXPLORE,       this::exploreConcept);
    ...
    private Json typesOfConcept(Request request, Response response){
        ...
        try(GraknGraph graph = factory.getGraph(keyspace, READ)){
            ...
            if (concept.isEntity()) {
                Collection<RoleType> rolesOfType = concept.asEntity().type().playsRoles();
