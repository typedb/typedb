...
/**
 * <p>
 *     Controls when types are updated with their new instance counts
 * </p>
 *
 * <p>
 *     This is executed as a result of receiving a commit log.
 * </p>
 *
 * @author Filipe Peliz Pinto Teixeira
 */
public class UpdateInstanceCount {
    private final static Logger LOG = LoggerFactory.getLogger(UpdateInstanceCount.class);
    ...
    public UpdateInstanceCount(GraknEngineConfig engineConfig, RedisCountStorage redis, EngineGraknTxFactory factory, LockProvider lockProvider, MetricRegistry metricRegistry){
    ...
    public void updateCounts(Keyspace keyspace, Json config){
        ...
        try (Timer.Context context = metricRegistry.timer(name(UpdateInstanceCount.class, "execution")).time()) {
            Map<ConceptId, Long> jobs = getCountUpdatingJobs(config);
