...
public class EntityTypeIT {
    ...
    public void whenAddingResourcesWithSubTypesToEntityTypes_EnsureImplicitStructureFollowsSubTypes(){
        ...
        RelationshipType superRelation = tx.<RelationshipType>getSchemaConcept(Schema.ImplicitType.HAS.getLabel(superAttributeType.label()));
    ...
    public void whenAddingResourceWithAbstractSuperTypeToEntityType_EnsureImplicitStructureFollowsSubTypes(){
        ...
        //Check Implicit Types Follow SUB Structure
        RelationshipType superRelation = tx.getRelationshipType(Schema.ImplicitType.HAS.getLabel(superAttributeType.label()).getValue());
        ...
        RelationshipType relation = tx.getRelationshipType(Schema.ImplicitType.HAS.getLabel(attributeType.label()).getValue());
        ...
        RelationshipType metaRelation = tx.getRelationshipType(Schema.ImplicitType.HAS.getLabel(metaType.label()).getValue());
