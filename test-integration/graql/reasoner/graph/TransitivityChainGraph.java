...
public class TransitivityChainGraph {
    ...
    private void loadSchema() {
        try {
            InputStream inputStream = TransitivityChainGraph.class.getClassLoader().getResourceAsStream("test-integration/graql/reasoner/resources/quadraticTransitivity.gql");
