...
public class RuleApplicabilityIT {
    ...
    public void metaImplicitRelation(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            grakn.core.graql.reasoner.atom.Atom metaImplicitRelation = ReasonerQueries.atomic(conjunction("{ $x isa @has-attribute;};", tx), tx).getAtom();
    ...
    public void OntologicalAtomsDoNotMatchAnyRules(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            grakn.core.graql.reasoner.atom.Atom subAtom = ReasonerQueries.atomic(conjunction("{ $x sub relation; };", tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom hasAtom = ReasonerQueries.atomic(conjunction("{ $x has description; };", tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relatesAtom = ReasonerQueries.atomic(conjunction("{ reifiable-relation relates $x; };", tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relatesAtom2 = ReasonerQueries.atomic(conjunction("{ $x relates someRole; };", tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom playsAtom = ReasonerQueries.atomic(conjunction("{ $x plays someRole; };", tx), tx).getAtom();
    ...
    public void attributeBoundRelationPlayers(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()){
            ...
            grakn.core.graql.reasoner.atom.Atom relation = ReasonerQueries.create(conjunction(relationString, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            grakn.core.graql.reasoner.atom.Atom relation2 = ReasonerQueries.create(conjunction(relationString2, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            grakn.core.graql.reasoner.atom.Atom relation3 = ReasonerQueries.create(conjunction(relationString3, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            grakn.core.graql.reasoner.atom.Atom relation4 = ReasonerQueries.create(conjunction(relationString4, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            Set<InferenceRule> rules = tx.ruleCache().getRules().map(r -> new InferenceRule(r, tx)).collect(Collectors.toSet());
    ...
    public void MissingRelationPlayers(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom relation = ReasonerQueries.atomic(conjunction(relationString, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relation2 = ReasonerQueries.atomic(conjunction(relationString2, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relation3 = ReasonerQueries.atomic(conjunction(relationString3, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relation4 = ReasonerQueries.atomic(conjunction(relationString4, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relation5 = ReasonerQueries.atomic(conjunction(relationString5, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom relation6 = ReasonerQueries.atomic(conjunction(relationString6, tx), tx).getAtom();
    ...
    public void TypedResources(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom resource = ReasonerQueries.create(conjunction(relationString, tx), tx).getAtoms(AttributeAtom.class).findFirst().orElse(null);
            grakn.core.graql.reasoner.atom.Atom resource2 = ReasonerQueries.create(conjunction(relationString2, tx), tx).getAtoms(AttributeAtom.class).findFirst().orElse(null);
            grakn.core.graql.reasoner.atom.Atom resource3 = ReasonerQueries.create(conjunction(relationString3, tx), tx).getAtoms(AttributeAtom.class).findFirst().orElse(null);
    ...
    public void DerivedTypes(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom type = ReasonerQueries.atomic(conjunction(typeString, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom type2 = ReasonerQueries.atomic(conjunction(typeString2, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom type3 = ReasonerQueries.atomic(conjunction(typeString3, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom type4 = ReasonerQueries.atomic(conjunction(typeString4, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom type5 = ReasonerQueries.atomic(conjunction(typeString5, tx), tx).getAtom();
    ...
    public void genericType(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom type = ReasonerQueries.atomic(conjunction(typeString, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom type2 = ReasonerQueries.atomic(conjunction(typeString2, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom type3 = ReasonerQueries.create(conjunction(typeString3, tx), tx).getAtoms(IsaAtom.class).filter(at -> at.getSchemaConcept() == null).findFirst().orElse(null);
    ...
    public void genericTypeAsARoleplayer(){
        try(TransactionOLTP tx = ruleApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom type = ReasonerQueries.create(conjunction(typeString, tx), tx).getAtoms(IsaAtom.class).findFirst().orElse(null);
            grakn.core.graql.reasoner.atom.Atom type2 = ReasonerQueries.create(conjunction(typeString2, tx), tx).getAtoms(IsaAtom.class).findFirst().orElse(null);
    ...
    public void ResourceDouble(){
        try(TransactionOLTP tx = resourceApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom resource = ReasonerQueries.atomic(conjunction(resourceString, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource2 = ReasonerQueries.atomic(conjunction(resourceString2, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource3 = ReasonerQueries.atomic(conjunction(resourceString3, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource4 = ReasonerQueries.atomic(conjunction(resourceString4, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource5 = ReasonerQueries.atomic(conjunction(resourceString5, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource6 = ReasonerQueries.atomic(conjunction(resourceString6, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource7 = ReasonerQueries.atomic(conjunction(resourceString7, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom resource8 = ReasonerQueries.atomic(conjunction(resourceString8, tx), tx).getAtom();
    ...
    public void ReifiedResourceDouble(){
        try(TransactionOLTP tx = reifiedResourceApplicabilitySession.transaction().write()) {
            ...
            grakn.core.graql.reasoner.atom.Atom atom = ReasonerQueries.atomic(conjunction(queryString, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom2 = ReasonerQueries.atomic(conjunction(queryString2, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom3 = ReasonerQueries.atomic(conjunction(queryString3, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom4 = ReasonerQueries.atomic(conjunction(queryString4, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom5 = ReasonerQueries.atomic(conjunction(queryString5, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom6 = ReasonerQueries.atomic(conjunction(queryString6, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom7 = ReasonerQueries.atomic(conjunction(queryString7, tx), tx).getAtom();
            grakn.core.graql.reasoner.atom.Atom atom8 = ReasonerQueries.atomic(conjunction(queryString8, tx), tx).getAtom();
