...
public class RuleApplicabilityIT {
    ...
    public void metaImplicitRelation(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            Atom metaImplicitRelation = reasonerQueryFactory.atomic(conjunction("{ $x isa @has-attribute;};", tx), tx).getAtom();
    ...
    public void OntologicalAtomsDoNotMatchAnyRules(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            Atom subAtom = reasonerQueryFactory.atomic(conjunction("{ $x sub relation; };", tx), tx).getAtom();
            Atom hasAtom = reasonerQueryFactory.atomic(conjunction("{ $x has description; };", tx), tx).getAtom();
            Atom relatesAtom = reasonerQueryFactory.atomic(conjunction("{ reifiable-relation relates $x; };", tx), tx).getAtom();
            Atom relatesAtom2 = reasonerQueryFactory.atomic(conjunction("{ $x relates someRole; };", tx), tx).getAtom();
            Atom playsAtom = reasonerQueryFactory.atomic(conjunction("{ $x plays someRole; };", tx), tx).getAtom();
    ...
    public void AmbiguousRoleMapping(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            ...
            RelationAtom relation = (RelationAtom) reasonerQueryFactory.atomic(conjunction(relationString, tx), tx).getAtom();
    ...
    public void attributeBoundRelationPlayers(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()){
            ...
            Atom relation = reasonerQueryFactory.create(conjunction(relationString, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            Atom relation2 = reasonerQueryFactory.create(conjunction(relationString2, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            Atom relation3 = reasonerQueryFactory.create(conjunction(relationString3, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            Atom relation4 = reasonerQueryFactory.create(conjunction(relationString4, tx), tx).getAtoms(RelationAtom.class).findFirst().orElse(null);
            Set<InferenceRule> rules = tx.ruleCache().getRules().map(r -> new InferenceRule(r, tx)).collect(Collectors.toSet());
    ...
    public void MissingRelationPlayers(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            ...
            Atom relation = reasonerQueryFactory.atomic(conjunction(relationString, tx), tx).getAtom();
            Atom relation2 = reasonerQueryFactory.atomic(conjunction(relationString2, tx), tx).getAtom();
            Atom relation3 = reasonerQueryFactory.atomic(conjunction(relationString3, tx), tx).getAtom();
            Atom relation4 = reasonerQueryFactory.atomic(conjunction(relationString4, tx), tx).getAtom();
            Atom relation5 = reasonerQueryFactory.atomic(conjunction(relationString5, tx), tx).getAtom();
            Atom relation6 = reasonerQueryFactory.atomic(conjunction(relationString6, tx), tx).getAtom();
    ...
    public void TypedResources(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            ...
            Atom resource = reasonerQueryFactory.create(conjunction(relationString, tx), tx).getAtoms(AttributeAtom.class).findFirst().orElse(null);
            Atom resource2 = reasonerQueryFactory.create(conjunction(relationString2, tx), tx).getAtoms(AttributeAtom.class).findFirst().orElse(null);
            Atom resource3 = reasonerQueryFactory.create(conjunction(relationString3, tx), tx).getAtoms(AttributeAtom.class).findFirst().orElse(null);
    ...
    public void DerivedTypes(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            ...
            Atom type = reasonerQueryFactory.atomic(conjunction(typeString, tx), tx).getAtom();
            Atom type2 = reasonerQueryFactory.atomic(conjunction(typeString2, tx), tx).getAtom();
            Atom type3 = reasonerQueryFactory.atomic(conjunction(typeString3, tx), tx).getAtom();
            Atom type4 = reasonerQueryFactory.atomic(conjunction(typeString4, tx), tx).getAtom();
            Atom type5 = reasonerQueryFactory.atomic(conjunction(typeString5, tx), tx).getAtom();
    ...
    public void genericType(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            ...
            Atom type = reasonerQueryFactory.atomic(conjunction(typeString, tx), tx).getAtom();
            Atom type2 = reasonerQueryFactory.atomic(conjunction(typeString2, tx), tx).getAtom();
            Atom type3 = reasonerQueryFactory.create(conjunction(typeString3, tx), tx).getAtoms(IsaAtom.class).filter(at -> at.getSchemaConcept() == null).findFirst().orElse(null);
    ...
    public void genericTypeAsARoleplayer(){
        try(Transaction tx = ruleApplicabilitySession.writeTransaction()) {
            ...
            Atom type = reasonerQueryFactory.create(conjunction(typeString, tx), tx).getAtoms(IsaAtom.class).findFirst().orElse(null);
            Atom type2 = reasonerQueryFactory.create(conjunction(typeString2, tx), tx).getAtoms(IsaAtom.class).findFirst().orElse(null);
    ...
    public void ResourceDouble(){
        try(Transaction tx = resourceApplicabilitySession.writeTransaction()) {
            ...
            Atom resource = reasonerQueryFactory.atomic(conjunction(resourceString, tx), tx).getAtom();
            Atom resource2 = reasonerQueryFactory.atomic(conjunction(resourceString2, tx), tx).getAtom();
            Atom resource3 = reasonerQueryFactory.atomic(conjunction(resourceString3, tx), tx).getAtom();
            Atom resource4 = reasonerQueryFactory.atomic(conjunction(resourceString4, tx), tx).getAtom();
            Atom resource5 = reasonerQueryFactory.atomic(conjunction(resourceString5, tx), tx).getAtom();
            Atom resource6 = reasonerQueryFactory.atomic(conjunction(resourceString6, tx), tx).getAtom();
            Atom resource7 = reasonerQueryFactory.atomic(conjunction(resourceString7, tx), tx).getAtom();
            Atom resource8 = reasonerQueryFactory.atomic(conjunction(resourceString8, tx), tx).getAtom();
    ...
    public void ReifiedResourceDouble(){
        try(Transaction tx = reifiedResourceApplicabilitySession.writeTransaction()) {
            ...
            Atom atom = reasonerQueryFactory.atomic(conjunction(queryString, tx), tx).getAtom();
            Atom atom2 = reasonerQueryFactory.atomic(conjunction(queryString2, tx), tx).getAtom();
            Atom atom3 = reasonerQueryFactory.atomic(conjunction(queryString3, tx), tx).getAtom();
            Atom atom4 = reasonerQueryFactory.atomic(conjunction(queryString4, tx), tx).getAtom();
            Atom atom5 = reasonerQueryFactory.atomic(conjunction(queryString5, tx), tx).getAtom();
            Atom atom6 = reasonerQueryFactory.atomic(conjunction(queryString6, tx), tx).getAtom();
            Atom atom7 = reasonerQueryFactory.atomic(conjunction(queryString7, tx), tx).getAtom();
            Atom atom8 = reasonerQueryFactory.atomic(conjunction(queryString8, tx), tx).getAtom();
