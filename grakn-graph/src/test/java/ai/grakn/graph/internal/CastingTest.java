...
public class CastingTest extends GraphTestBase {
    ...
    public void whenUpdatingRelation_EnsureRolePlayersAreUpdated(){
        ...
        Set<Thing> things = relation.reified().castingsRelation().map(Casting::getInstance).collect(Collectors.toSet());
        Set<Role> roles = relation.reified().castingsRelation().map(Casting::getRoleType).collect(Collectors.toSet());
        ...
        things = relation.reified().castingsRelation().map(Casting::getInstance).collect(Collectors.toSet());
        roles = relation.reified().castingsRelation().map(Casting::getRoleType).collect(Collectors.toSet());
