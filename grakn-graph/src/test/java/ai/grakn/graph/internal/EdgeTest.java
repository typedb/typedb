...
public class EdgeTest extends GraphTestBase{
    ...
    public void createEdge(){
        ...
        Edge tinkerEdge = graknGraph.getTinkerTraversal().has(Schema.VertexProperty.ID.name(), entity.getId().getValue()).outE().next();
    ...
    public void checkEqualityBetweenEdgesBasedOnID(){
        ...
        Edge tinkerEdge = graknGraph.getTinkerTraversal().has(Schema.VertexProperty.ID.name(), entity2.getId().getValue()).outE().next();
