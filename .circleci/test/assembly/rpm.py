...
try:
    ...
    gcloud_ssh(instance, 'curl -OL https://github.com/bazelbuild/bazel/releases/download/0.23.2/bazel-0.23.2-installer-linux-x86_64.sh')
    gcloud_ssh(instance, 'chmod +x bazel-0.23.2-installer-linux-x86_64.sh')
    gcloud_ssh(instance, 'sudo ./bazel-0.23.2-installer-linux-x86_64.sh')
    gcloud_ssh(instance, 'rm ./bazel-0.23.2-installer-linux-x86_64.sh')
