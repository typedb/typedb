...
public class ResolutionTest {
    ...
    private TransactionImpl singleThreadElgTransaction(SessionImpl session) {
        TransactionImpl transaction = session.transaction(Arguments.Transaction.Type.WRITE);
    ...
    private void createRootAndAssertResponses(TransactionImpl transaction, Disjunction disjunction,
    ...
    private void createRootAndAssertResponses(TransactionImpl transaction, Conjunction conjunction, long answerCount, long explainableAnswers)
