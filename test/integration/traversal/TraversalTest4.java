...
public class TraversalTest4 {
    private static Path directory = Paths.get("/Users/haikalpribadi/Workspace/git/graknlabs/grakn/data/simulation");
    ...
    public void test_simulation_traversal_repeat() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            try {
                ...
                success++;
                System.out.println(java.lang.String.format("Success: %s, Fail: %s", success, fail));
...
//                            "(child: $person, place-of-birth: $location) isa born-in;\n" +
    ...
    public void test_simulation_traversal_procedure() {
        ...
        Predicate.Value.String predicate = Predicate.Value.String.of(EQ);
