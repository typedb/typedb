...
public class AttributeIT {
    ...
    public void whenCreatingResourceWithAnInvalidValueType_Throw() {
        ...
        expectedException.expectMessage(GraknConceptException.invalidAttributeValueWrite(longAttributeType, invalidThing).getMessage());
    ...
    public void whenCreatingResourceWithAnInvalidValueTypeOnADate_Throw() {
        ...
        expectedException.expect(GraknConceptException.class);
        expectedException.expectMessage(GraknConceptException.invalidAttributeValueWrite(dateAttributeType, invalidThing).getMessage());
