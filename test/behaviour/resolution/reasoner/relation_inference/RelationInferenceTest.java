...
package grakn.core.test.behaviour.resolution.reasoner.relation_inference;
...
@CucumberOptions(
        ...
        features = "external/graknlabs_verification/behaviour/graql/reasoner/resolution/relation-inference.feature",
...
public class RelationInferenceTest {
    ...
    // 3) Select 'Bazel test RelationInferenceTest'
    //
