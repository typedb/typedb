...
public class ThingSteps {
    ...
    public static Thing get(final String variable) {
        return things.get(variable);
    }

    public static void put(final String variable, final Thing thing) {
        things.put(variable, thing);
    }

    public static void remove(final String variable) {
        things.remove(variable);
    }

    @Then("entity/attribute/relation {var} is null: {bool}")
    public void thing_is_null(final String var, final boolean isNull) {
        assertEquals(isNull, isNull(get(var)));
    }

    @Then("entity/attribute/relation {var} is deleted: {bool}")
    public void thing_is_deleted(final String var, final boolean isDeleted) {
        assertEquals(isDeleted, get(var).isDeleted());
    }

    @Then("{root_label} {var} has type: {type_label}")
    public void thing_has_type(final RootLabel rootLabel, final String var, final String typeLabel) {
    ...
    public void thing_get_keys_do_not_contain(final String var1, final String var2) {
    ...
    public void thing_get_attributes_contain(final String var1, final String var2) {
    ...
    public void thing_get_attributes_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_boolean_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_long_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_double_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_string_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_datetime_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_do_not_contain(final String var1, final String var2) {
    ...
    public void thing_get_attributes_do_not_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_boolean_do_not_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_long_do_not_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_double_do_not_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_string_do_not_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_attributes_as_datetime_do_not_contain(final String var1, final String typeLabel, final String var2) {
    ...
    public void thing_get_relations_contain(final String var1, final ScopedLabel scopedLabel, final String var2) {
    ...
    public void thing_get_relations_contain(final String var1, final String var2) {
    ...
    public void thing_get_relations_do_not_contain(final String var1, final ScopedLabel scopedLabel, final String var2) {
        assertTrue(get(var1).getRelations(tx().concepts().getRelationType(scopedLabel.scope()).getRelates(scopedLabel.role()))
                           .noneMatch(k -> k.equals(get(var2))));
    }

    @Then("entity/attribute/relation {var} get relations do not contain: {var}")
    public void thing_get_relations_do_not_contain(final String var1, final String var2) {
        assertTrue(get(var1).getRelations().noneMatch(k -> k.equals(get(var2))));
    }

    @Then("root\\( ?thing ?) get instances count: {int}")
    public void root_thing_type_get_instances_contain(final int count) {
        assertEquals(count, tx().concepts().getRootThingType().getInstances().count());
    }

    @Then("root\\( ?thing ?) get instances contain: {var}")
    public void root_thing_type_get_instances_contain(final String var) {
