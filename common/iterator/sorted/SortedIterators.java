...
public class SortedIterators {
    ...
    public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator<T, ORDER> iterateSorted(ORDER order, List<T> list) {
    ...
    public static class Forwardable {
        ...
        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> emptySorted(ORDER order) {
            return iterateSorted(new TreeSet<T>(), order);
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> iterateSorted(Collection<T> elements, ORDER order) {
            return new BaseForwardableIterator<>(new TreeSet<>(elements), order);
        }

        @SafeVarargs
        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> iterateSorted(ORDER order, T... elements) {
            return new BaseForwardableIterator<>(new TreeSet<>(list(elements)), order);
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> iterateSorted(NavigableSet<T> set, ORDER order) {
            return new BaseForwardableIterator<>(set, order);
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> distinct(SortedIterator.Forwardable<T, ORDER> iterator) {
            return new DistinctSortedIterator.Forwardable<>(iterator);
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> filter(SortedIterator.Forwardable<T, ORDER> iterator,
                                                                                                                         Predicate<T> predicate) {
            return new FilteredSortedIterator.Forwardable<>(iterator, predicate);
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> limit(SortedIterator.Forwardable<T, ORDER> iterator,
                                                                                                                        long limit) {
        ...
        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> merge(FunctionalIterator<SortedIterator.Forwardable<T, ORDER>> iterators, ORDER order) {
            return new MergeMappedSortedIterator.Forwardable<>(iterators, e -> e, order);
        }

        @SafeVarargs
        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> intersect(SortedIterator.Forwardable<T, ORDER> iterator, SortedIterator.Forwardable<T, ORDER>... iterators) {
            return new IntersectForwardableIterator<>(list(list(iterators), iterator), iterator.order());
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> intersect(FunctionalIterator<SortedIterator.Forwardable<T, ORDER>> iterators, ORDER order) {
        ...
        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> onConsume(SortedIterator.Forwardable<T, ORDER> iterator,
                                                                                                                            Runnable onConsume) {
            return new ConsumeHandledSortedIterator.Forwardable<>(iterator, onConsume);
        }

        public static <T extends Comparable<? super T>, ORDER extends Order> SortedIterator.Forwardable<T, ORDER> onFinalise(SortedIterator.Forwardable<T, ORDER> iterator,
                                                                                                                             Runnable finalise) {
