...
public class CoreStatisticReporter implements StatisticReporter {
    ...
    CoreStatisticReporter(String reportingURI) {
    ...
    void push() {
        try {
            ...
            conn.getOutputStream().write(Diagnostics.get().metrics.formatJSON().getBytes(StandardCharsets.UTF_8));
