...
public enum ErrorMessage {
    ...
    ILLEGAL_TYPE_UNKEY_ATTRIBUTE_WITH_INSTANCE("Failed to: undefine [%s] key [%s]. There exists instance of this pattern."),
    ILLEGAL_TYPE_UNHAS_ATTRIBUTE_WITH_INSTANCE("Failed to: undefine [%s] has [%s]. There exists instance of this pattern."),
    ILLEGAL_TYPE_UNKEY_ATTRIBUTE_INHERITED("Failed to: undefine [%s] key [%s]. Key property is inherited from a super type."),
    ILLEGAL_TYPE_UNHAS_ATTRIBUTE_INHERITED("Failed to: undefine [%s] has [%s]. Has property is inherited from a super type."),
