...
public class ReasonerQueries {
     ...
     */
    public static ReasonerQueryImpl create(List<grakn.core.kb.reasoner.atom.Atom> as, Transaction tx){
     ...
     */
    public static ReasonerAtomicQuery atomic(grakn.core.kb.reasoner.atom.Atom atom){
