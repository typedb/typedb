...
import grakn.core.kb.reasoner.state.AtomicState;
import grakn.core.kb.reasoner.state.AtomicStateProducer;
import grakn.core.kb.reasoner.state.CacheCompletionState;
...
public class ReasonerAtomicQuery extends ReasonerQueryImpl {
    ...
    private final grakn.core.kb.reasoner.atom.Atom atom;
    ...
    ReasonerAtomicQuery(grakn.core.kb.reasoner.atom.Atom at) {
        super(at);
        this.atom = Iterables.getOnlyElement(selectAtoms()::iterator);
    }
    ...
    @Override
    public String toString(){ return getAtoms(grakn.core.kb.reasoner.atom.Atom.class).map(Atomic::toString).collect(Collectors.joining(", "));}
     ...
     */
    public grakn.core.kb.reasoner.atom.Atom getAtom() {
        return atom;
    }
    ...
    @Override
    public Iterator<grakn.core.kb.reasoner.state.ResolutionState> innerStateIterator(grakn.core.kb.reasoner.state.AnswerPropagatorState parent, Set<ReasonerAtomicQuery> visitedSubGoals) {
        ...
        Iterator<grakn.core.kb.reasoner.state.ResolutionState> dbCompletionIterator =
        ...
        Iterator<grakn.core.kb.reasoner.state.ResolutionState> subGoalIterator = !doNotResolveFurther?
     ...
     */
    private Iterator<grakn.core.kb.reasoner.state.ResolutionState> ruleStateIterator(grakn.core.kb.reasoner.state.AnswerPropagatorState parent, Set<ReasonerAtomicQuery> visitedSubGoals) {
        return RuleUtils
