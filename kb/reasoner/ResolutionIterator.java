...
package grakn.core.kb.reasoner;
...
public class ResolutionIterator extends ReasonerQueryIterator {
    ...
    private final Stack<grakn.core.kb.reasoner.state.ResolutionState> states = new Stack<>();
    ...
    private ConceptMap findNextAnswer(){
        while(!states.isEmpty()) {
            grakn.core.kb.reasoner.state.ResolutionState state = states.pop();
            ...
            grakn.core.kb.reasoner.state.ResolutionState newState = state.generateChildState();
            if (newState != null) {
