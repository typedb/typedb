...
public final class ResolutionPlan {
    ...
    private final ImmutableList<grakn.core.kb.reasoner.atom.Atom> plan;
     ...
     */
    public ImmutableList<grakn.core.kb.reasoner.atom.Atom> plan(){ return plan;}
    ...
    private void validatePlan() {
        ...
        Iterator<grakn.core.kb.reasoner.atom.Atom> iterator = plan.iterator();
