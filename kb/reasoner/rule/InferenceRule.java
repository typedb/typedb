...
package grakn.core.kb.reasoner.rule;
...
import grakn.core.kb.reasoner.atom.binary.TypeAtom;
...
import grakn.core.kb.reasoner.state.RuleState;
...
public class InferenceRule {
    ...
    private grakn.core.kb.reasoner.atom.Atom conclusionAtom = null;
    ...
    long resolutionPriority(){
        if (priority == Long.MAX_VALUE) {
            ...
            boolean bodyRuleResolvable = getBody().getAtoms(grakn.core.kb.reasoner.atom.Atom.class)
                    .map(grakn.core.kb.reasoner.atom.Atom::getSchemaConcept)
     ...
     */
    public boolean requiresMaterialisation(grakn.core.kb.reasoner.atom.Atom parentAtom){
     ...
     */
    public grakn.core.kb.reasoner.atom.Atom getRuleConclusionAtom() {
        if (conclusionAtom == null) {
            conclusionAtom = getCombinedQuery().getAtoms(grakn.core.kb.reasoner.atom.Atom.class)
     ...
     */
    private InferenceRule propagateConstraints(grakn.core.kb.reasoner.atom.Atom parentAtom, Unifier unifier){
        if (!parentAtom.isRelation() && !parentAtom.isResource()) return this;
        grakn.core.kb.reasoner.atom.Atom headAtom = head.getAtom();
    ...
    public boolean appendsRolePlayers(){
        grakn.core.kb.reasoner.atom.Atom headAtom = getHead().getAtom();
    ...
    private InferenceRule rewriteHeadToRelation(grakn.core.kb.reasoner.atom.Atom parentAtom){
    ...
    private InferenceRule rewriteVariables(grakn.core.kb.reasoner.atom.Atom parentAtom){
     ...
     */
    public InferenceRule rewrite(grakn.core.kb.reasoner.atom.Atom parentAtom){
        return this
                .rewriteBodyAtoms()
     ...
     */
    public MultiUnifier getMultiUnifier(grakn.core.kb.reasoner.atom.Atom parentAtom) {
        grakn.core.kb.reasoner.atom.Atom childAtom = getRuleConclusionAtom();
        ...
        //case of match all atom (atom without type)
            ...
            grakn.core.kb.reasoner.atom.Atom extendedParent = parentAtom
     ...
     */
    public grakn.core.kb.reasoner.state.ResolutionState subGoal(grakn.core.kb.reasoner.atom.Atom parentAtom, Unifier ruleUnifier, grakn.core.kb.reasoner.state.AnswerPropagatorState parent, Set<ReasonerAtomicQuery> visitedSubGoals){
