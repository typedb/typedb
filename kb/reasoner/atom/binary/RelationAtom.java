 ...
 *
 */
package grakn.core.kb.reasoner.atom.binary;
...
import grakn.core.kb.reasoner.utils.conversion.RoleConverter;
import grakn.core.kb.reasoner.utils.conversion.TypeConverter;
...
public abstract class RelationAtom extends IsaAtomBase {
    ...
    @Override
    public Set<grakn.core.kb.reasoner.atom.Atom> rewriteToAtoms(){
    ...
    @Override
    public boolean isRuleApplicableViaAtom(grakn.core.kb.reasoner.atom.Atom ruleAtom) {
    ...
    @Override
    public List<grakn.core.kb.reasoner.atom.Atom> atomOptions(ConceptMap sub) {
        return this.inferPossibleTypes(sub).stream()
                ...
                .sorted(Comparator.comparing(grakn.core.kb.reasoner.atom.Atom::isRuleResolvable))
    ...
    @Override
    public Unifier getUnifier(grakn.core.kb.reasoner.atom.Atom pAtom, UnifierType unifierType){
    ...
    @Override
    public SemanticDifference semanticDifference(grakn.core.kb.reasoner.atom.Atom child, Unifier unifier) {
     ...
     */
    private RelationAtom rewriteWithVariableRoles(grakn.core.kb.reasoner.atom.Atom parentAtom){
     ...
     */
    private RelationAtom rewriteWithRelationVariable(grakn.core.kb.reasoner.atom.Atom parentAtom){
    ...
    @Override
    public grakn.core.kb.reasoner.atom.Atom rewriteToUserDefined(grakn.core.kb.reasoner.atom.Atom parentAtom){
        return this
