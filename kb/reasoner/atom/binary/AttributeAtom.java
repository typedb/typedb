...
public abstract class AttributeAtom extends Binary{
    ...
    public Set<String> validateAsRuleHead(Rule rule){
        ...
        if (getMultiPredicate().isEmpty()){
            boolean predicateBound = getParentQuery().getAtoms(grakn.core.kb.reasoner.atom.Atom.class)
    ...
    @Override
    public Unifier getUnifier(grakn.core.kb.reasoner.atom.Atom parentAtom, UnifierType unifierType) {
     ...
     */
    private AttributeAtom rewriteWithRelationVariable(grakn.core.kb.reasoner.atom.Atom parentAtom){
    ...
    @Override
    public grakn.core.kb.reasoner.atom.Atom rewriteWithTypeVariable() {
