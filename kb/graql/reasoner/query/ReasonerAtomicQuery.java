...
import grakn.core.kb.graql.reasoner.cache.SemanticDifference;
...
import grakn.core.kb.graql.reasoner.state.AtomicState;
import grakn.core.kb.graql.reasoner.state.AtomicStateProducer;
import grakn.core.kb.graql.reasoner.state.CacheCompletionState;
