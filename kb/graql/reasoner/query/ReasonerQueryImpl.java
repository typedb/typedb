...
import grakn.core.kb.graql.reasoner.atom.AtomicBase;
import grakn.core.kb.graql.reasoner.atom.AtomicFactory;
import grakn.core.kb.graql.reasoner.atom.binary.IsaAtom;
import grakn.core.kb.graql.reasoner.atom.binary.IsaAtomBase;
...
import grakn.core.kb.graql.reasoner.atom.predicate.VariablePredicate;
import grakn.core.kb.graql.reasoner.cache.Index;
import grakn.core.kb.graql.reasoner.explanation.JoinExplanation;
import grakn.core.kb.graql.reasoner.explanation.LookupExplanation;
import grakn.core.kb.graql.reasoner.plan.GraqlTraversalPlanner;
...
import grakn.core.kb.graql.reasoner.state.AnswerPropagatorState;
import grakn.core.kb.graql.reasoner.state.AnswerState;
import grakn.core.kb.graql.reasoner.state.ConjunctiveState;
import grakn.core.kb.graql.reasoner.state.CumulativeState;
import grakn.core.kb.graql.reasoner.state.ResolutionState;
import grakn.core.kb.graql.reasoner.state.VariableComparisonState;
