...
CodeMirror.defineSimpleMode('graql', {
  ...
  start: [
    { regex: /#.*/, token: 'comment' },
    { regex: /".*?"/, token: 'string' },
    { regex: /(match|insert|delete|select|isa|sub|plays|relates|has-scope|datatype|is-abstract|has|value|id|of|limit|offset|order|by|compute|from|to|in|aggregate|label)(?![-a-zA-Z_0-9])/, // eslint-disable-line max-len
      token: 'keyword' },
