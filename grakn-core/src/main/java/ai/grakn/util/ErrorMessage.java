...
public enum ErrorMessage {
    ...
    INVALID_COMPUTE_COUNT_CONDITION("Invalid 'compute count' condition. " +
            "Only 'in <types>' is expected, such as: 'compute count in [person, movie]];'."),

    INVALID_COMPUTE_MIN_CONDITION("Invalid 'compute min' condition. " +
            "Only 'of <types>' and 'in <types>' are expected, such as: 'compute min of age, in [person, animal];'."),
    ...
    INVALID_COMPUTE_MAX_CONDITION("Invalid 'compute max' condition. " +
            "Only 'of <types>' and 'in <types>' are expected, such as: 'compute max of age, in [person, animal];'."),
    ...
    INVALID_COMPUTE_MEDIAN_CONDITION("Invalid 'compute median' condition. " +
            "Only 'of <types>' and 'in <types>' are expected, such as: 'compute median of age, in [person, animal];'."),
    ...
    INVALID_COMPUTE_MEAN_CONDITION("Invalid 'compute mean' condition. " +
            "Only 'of <types>' and 'in <types>' are expected, such as: 'compute mean of age, in [person, animal];'."),
    ...
    INVALID_COMPUTE_STD_CONDITION("Invalid 'compute std' condition. " +
            "Only 'of <types>' and 'in <types>' are expected, such as: 'compute std of age, in [person, animal];'."),
    ...
    INVALID_COMPUTE_SUM_CONDITION("Invalid 'compute sum' condition. " +
            "Only 'of <types>' and 'in <types>' are expected, such as: 'compute sum of age, in [person, animal];'."),
    ...
    INVALID_COMPUTE_PATH_CONDITION("Invalid 'compute path' condition. " +
            "Only 'from <id>', 'to <id', and 'in <types>' are expected, " +
    ...
    INVALID_COMPUTE_CENTRALITY_CONDITION("Invalid 'compute centrality' condition. " +
            "Only 'of <types>', 'in <types>', 'using <algorithm>' and 'where <args>' are expected, " +
            "such as: 'compute centrality of person, in [person, marriage], using k-core, where min-k=10;'. " +
            "Note that when performing 'compute centrality using degree', 'where <args' is not expected."),
