...
public enum ErrorMessage {
    ...
    INVALID_COMPUTE_MIN_CONDITION("Invalid 'compute min' condition. Only 'of <subgraph>' and 'in <subgraph', such as: 'compute min of age, in [person, animal'."),
    INVALID_COMPUTE_MIN_MISSING_CONDITION("Missing 'compute min' condition. 'of <subgraph>' is required, such as: 'compute min of age'."),
    INVALID_COMPUTE_MAX_CONDITION("Invalid 'compute max' condition. Only 'of <subgraph>' and 'in <subgraph', such as: 'compute max of age, in [person, animal'."),
    INVALID_COMPUTE_MAX_MISSING_CONDITION("Missing 'compute max' condition. 'of <subgraph>' is required, such as: 'compute max of age'."),
    INVALID_COMPUTE_MEDIAN_CONDITION("Invalid 'compute median' condition. Only 'of <subgraph>' and 'in <subgraph', such as: 'compute median of age, in [person, animal'."),
    INVALID_COMPUTE_MEDIAN_MISSING_CONDITION("Missing 'compute median' condition. 'of <subgraph>' is required, such as: 'compute median of age'."),
    INVALID_COMPUTE_MEAN_CONDITION("Invalid 'compute mean' condition. Only 'of <subgraph>' and 'in <subgraph', such as: 'compute mean of age, in [person, animal'."),
    INVALID_COMPUTE_MEAN_MISSING_CONDITION("Missing 'compute mean' condition. 'of <subgraph>' is required, such as: 'compute mean of age'."),
    INVALID_COMPUTE_STD_CONDITION("Invalid 'compute std' condition. Only 'of <subgraph>' and 'in <subgraph', such as: 'compute std of age, in [person, animal'."),
    INVALID_COMPUTE_STD_MISSING_CONDITION("Missing 'compute std' condition. 'of <subgraph>' is required, such as: 'compute std of age'."),
    INVALID_COMPUTE_SUM_CONDITION("Invalid 'compute sum' condition. Only 'of <subgraph>' and 'in <subgraph', such as: 'compute sum of age, in [person, animal'."),
    INVALID_COMPUTE_SUM_MISSING_CONDITION("Missing 'compute msum' condition. 'of <subgraph>' is required, such as: 'compute sum of age'."),
    INVALID_COMPUTE_PATH_CONDITION("Invalid 'compute path' condition. Only 'from <id>', 'to <id', and 'in <subgraph>' can be given, such as: 'compute path from 123, to 456, in [movie, cast, person]'."),
    INVALID_COMPUTE_PATH_MISSING_CONDITION("Missing 'compute path' condition. 'from <id>' and 'to <id>' are required, such as: 'compute path from 123, to 456'."),
    INVALID_COMPUTE_PATHS_CONDITION("Invalid 'compute paths' condition. Only 'from <id>', 'to <id', and 'in <subgraph>' can be given, such as: 'compute paths from 123, to 456, in [movie, cast, person]'."),
    INVALID_COMPUTE_PATHS_MISSING_CONDITION("Missing 'compute paths' condition. 'from <id>' and 'to <id>' are required, such as: 'compute paths from 123, to 456'."),
