...
public enum ErrorMessage {
    ...
    MISSING_MANDATORY_QUERY_PARAMETERS("Missing mandatory query parameter [%s]"),
    MISSING_QUERY_POST_BODY("Empty POST body- it should contain the Graql query to be executed."),
