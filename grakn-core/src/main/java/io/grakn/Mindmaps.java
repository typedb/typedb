...
public class Mindmaps {
    ...
    private static final String ENGINE_CONTROLLED_IMPLEMENTATION = "io.grakn.factory.MindmapsGraphFactoryImpl";
    
    public static final String IN_MEMORY = "in-memory";
    private static final String IN_MEMORY_IMPLEMENTATION = "io.grakn.factory.MindmapsGraphFactoryInMemory";
