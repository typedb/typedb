...
class Dashboard(object):
    ...
    def __init__(self, max_interactive_graphs_per_execution=100):
        ...
        self._execution_selector = ExecutionSelector(self._sorted_executions)
    ...
    def _create_dynamic_callbacks(self, max_graphs):
        ...
        for i, execution_name in enumerate(self._sorted_executions):
            ...
            callback_definitions = ExecutionVisualiser.get_predeclared_callbacks(execution_number=i,
            ...
            for callback_function_name in callback_definitions:
                ...
                self._app.callback(callback_definition[0], callback_definition[1])(route_execution_callback(callback_function_name, execution_name))
    ...
    def _upsert_execution(self, execution_name):
        ...
        if execution_name not in self._executions:
            ...
            self._executions[execution_name] = ExecutionVisualiser(self.zipkinESStorage,
                                                                             execution_name,
                                                                             execution_number)
