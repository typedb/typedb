...
class Dashboard(object):
    ...
    class ExecutionVisualiser(object):
        def __init__(self, zipkinESStorage, execution_name, execution_number):
            ...
            assert Dashboard.ExecutionVisualiser.inorder(self._sorted_all_concept_numbers), "Concept numbers not sorted!"
            assert Dashboard.ExecutionVisualiser.inorder(self._sorted_all_queries), "Queries not sorted!"
