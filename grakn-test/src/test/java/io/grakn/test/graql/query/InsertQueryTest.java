...
import static io.grakn.concept.ResourceType.DataType.LONG;
import static io.grakn.concept.ResourceType.DataType.STRING;
...
public class InsertQueryTest extends AbstractMovieGraphTest {
    ...
    public void testInsertSub() {
        assertInsert(var("x").id("http://grakn.io/cool-movie").sub("movie"));
    }
