...
public class AdminTest {
    ...
    public void testInsertQueryGetTypes() {
        InsertQuery query = qb.insert(var("x").isa("person").has("name", var()), var().rel("actor", "x").isa("has-cast"));
    ...
    public void testMatchInsertQueryGetTypes() {
        InsertQuery query = qb.match(var("y").isa("movie"))
                        .insert(var("x").isa("person").has("name", var()), var().rel("actor", "x").isa("has-cast"));
