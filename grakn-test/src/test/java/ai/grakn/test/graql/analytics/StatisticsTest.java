...
public class StatisticsTest {
    ...
    private void addOntologyAndEntities() throws GraknValidationException {
        try (GraknGraph graph = factory.open(GraknTxType.WRITE)) {
            ...
            RoleType resourceOwner1 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType1)));
            RoleType resourceOwner2 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType2)));
            RoleType resourceOwner3 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType3)));
            RoleType resourceOwner4 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType4)));
            RoleType resourceOwner5 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType5)));
            RoleType resourceOwner6 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType6)));
            RoleType resourceOwner7 = graph.putRoleType(Schema.ImplicitType.HAS_OWNER.getName(TypeName.of(resourceType7)));

            RoleType resourceValue1 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType1)));
            RoleType resourceValue2 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType2)));
            RoleType resourceValue3 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType3)));
            RoleType resourceValue4 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType4)));
            RoleType resourceValue5 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType5)));
            RoleType resourceValue6 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType6)));
            RoleType resourceValue7 = graph.putRoleType(Schema.ImplicitType.HAS_VALUE.getName(TypeName.of(resourceType7)));

            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType1)))
                    .relates(resourceOwner1).relates(resourceValue1);
            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType2)))
                    .relates(resourceOwner2).relates(resourceValue2);
            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType3)))
                    .relates(resourceOwner3).relates(resourceValue3);
            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType4)))
                    .relates(resourceOwner4).relates(resourceValue4);
            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType5)))
                    .relates(resourceOwner5).relates(resourceValue5);
            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType6)))
                    .relates(resourceOwner6).relates(resourceValue6);
            graph.putRelationType(Schema.ImplicitType.HAS.getName(TypeName.of(resourceType7)))
