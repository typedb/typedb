...
public class ClusteringTest {
    ...
    private void addOntologyAndEntities() throws GraknValidationException {
        try (GraknGraph graph = factory.open(GraknTxType.WRITE)) {
            ...
            RoleType resourceOwner1 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType1)).getValue());
            RoleType resourceOwner2 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType2)).getValue());
            RoleType resourceOwner3 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType3)).getValue());
            RoleType resourceOwner4 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType4)).getValue());
            RoleType resourceOwner5 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType5)).getValue());
            RoleType resourceOwner6 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType6)).getValue());
            RoleType resourceOwner7 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType7)).getValue());

            RoleType resourceValue1 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType1)).getValue());
            RoleType resourceValue2 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType2)).getValue());
            RoleType resourceValue3 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType3)).getValue());
            RoleType resourceValue4 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType4)).getValue());
            RoleType resourceValue5 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType5)).getValue());
            RoleType resourceValue6 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType6)).getValue());
            RoleType resourceValue7 = graph.putRoleType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType7)).getValue());

            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType1)).getValue())
                    .hasRole(resourceOwner1).hasRole(resourceValue1);
            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType2)).getValue())
                    .hasRole(resourceOwner2).hasRole(resourceValue2);
            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType3)).getValue())
                    .hasRole(resourceOwner3).hasRole(resourceValue3);
            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType4)).getValue())
                    .hasRole(resourceOwner4).hasRole(resourceValue4);
            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType5)).getValue())
                    .hasRole(resourceOwner5).hasRole(resourceValue5);
            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType6)).getValue())
                    .hasRole(resourceOwner6).hasRole(resourceValue6);
            graph.putRelationType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType7)).getValue())
    ...
    private void addResourceRelations() throws GraknValidationException {
        try (GraknGraph graph = factory.open(GraknTxType.WRITE)) {
            ...
            RoleType resourceOwner1 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType1)));
            RoleType resourceOwner2 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType2)));
            RoleType resourceOwner3 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType3)));
            RoleType resourceOwner4 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType4)));
            RoleType resourceOwner5 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType5)));
            RoleType resourceOwner6 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_OWNER.getName(TypeLabel.of(resourceType6)));

            RoleType resourceValue1 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType1)));
            RoleType resourceValue2 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType2)));
            RoleType resourceValue3 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType3)));
            RoleType resourceValue4 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType4)));
            RoleType resourceValue5 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType5)));
            RoleType resourceValue6 = graph.getType(Schema.ImplicitType.HAS_RESOURCE_VALUE.getName(TypeLabel.of(resourceType6)));

            RelationType relationType1 = graph.getType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType1)));
            ...
            RelationType relationType2 = graph.getType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType2)));
            ...
            RelationType relationType5 = graph.getType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType5)));
            ...
            RelationType relationType6 = graph.getType(Schema.ImplicitType.HAS_RESOURCE.getName(TypeLabel.of(resourceType6)));
