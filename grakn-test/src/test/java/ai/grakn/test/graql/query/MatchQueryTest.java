...
import static ai.grakn.test.matcher.QueryUtil.aRuleType;
import static ai.grakn.test.matcher.QueryUtil.action;
import static ai.grakn.test.matcher.QueryUtil.alPacino;
import static ai.grakn.test.matcher.QueryUtil.allVariables;
import static ai.grakn.test.matcher.QueryUtil.apocalypseNow;
import static ai.grakn.test.matcher.QueryUtil.benjaminLWillard;
import static ai.grakn.test.matcher.QueryUtil.betteMidler;
import static ai.grakn.test.matcher.QueryUtil.character;
import static ai.grakn.test.matcher.QueryUtil.chineseCoffee;
import static ai.grakn.test.matcher.QueryUtil.cluster;
import static ai.grakn.test.matcher.QueryUtil.comedy;
import static ai.grakn.test.matcher.QueryUtil.concept;
import static ai.grakn.test.matcher.QueryUtil.constraintRule;
import static ai.grakn.test.matcher.QueryUtil.containsAllMovies;
import static ai.grakn.test.matcher.QueryUtil.crime;
import static ai.grakn.test.matcher.QueryUtil.drama;
import static ai.grakn.test.matcher.QueryUtil.entity;
import static ai.grakn.test.matcher.QueryUtil.family;
import static ai.grakn.test.matcher.QueryUtil.fantasy;
import static ai.grakn.test.matcher.QueryUtil.gender;
import static ai.grakn.test.matcher.QueryUtil.genre;
import static ai.grakn.test.matcher.QueryUtil.genreOfProduction;
import static ai.grakn.test.matcher.QueryUtil.godfather;
import static ai.grakn.test.matcher.QueryUtil.harry;
import static ai.grakn.test.matcher.QueryUtil.hasTitle;
import static ai.grakn.test.matcher.QueryUtil.hasType;
import static ai.grakn.test.matcher.QueryUtil.hasValue;
import static ai.grakn.test.matcher.QueryUtil.heat;
import static ai.grakn.test.matcher.QueryUtil.hocusPocus;
import static ai.grakn.test.matcher.QueryUtil.inferenceRule;
import static ai.grakn.test.matcher.QueryUtil.isCasting;
import static ai.grakn.test.matcher.QueryUtil.isInstance;
import static ai.grakn.test.matcher.QueryUtil.judeLaw;
import static ai.grakn.test.matcher.QueryUtil.kermitTheFrog;
import static ai.grakn.test.matcher.QueryUtil.language;
import static ai.grakn.test.matcher.QueryUtil.marlonBrando;
import static ai.grakn.test.matcher.QueryUtil.martinSheen;
import static ai.grakn.test.matcher.QueryUtil.mirandaHeart;
import static ai.grakn.test.matcher.QueryUtil.missPiggy;
import static ai.grakn.test.matcher.QueryUtil.movie;
import static ai.grakn.test.matcher.QueryUtil.movies;
import static ai.grakn.test.matcher.QueryUtil.musical;
import static ai.grakn.test.matcher.QueryUtil.name;
import static ai.grakn.test.matcher.QueryUtil.neilMcCauley;
import static ai.grakn.test.matcher.QueryUtil.person;
import static ai.grakn.test.matcher.QueryUtil.production;
import static ai.grakn.test.matcher.QueryUtil.realName;
import static ai.grakn.test.matcher.QueryUtil.releaseDate;
import static ai.grakn.test.matcher.QueryUtil.resource;
import static ai.grakn.test.matcher.QueryUtil.results;
import static ai.grakn.test.matcher.QueryUtil.robertDeNiro;
import static ai.grakn.test.matcher.QueryUtil.rule;
import static ai.grakn.test.matcher.QueryUtil.runtime;
import static ai.grakn.test.matcher.QueryUtil.sarah;
import static ai.grakn.test.matcher.QueryUtil.sarahJessicaParker;
import static ai.grakn.test.matcher.QueryUtil.spy;
import static ai.grakn.test.matcher.QueryUtil.theMuppets;
import static ai.grakn.test.matcher.QueryUtil.title;
import static ai.grakn.test.matcher.QueryUtil.tmdbVoteAverage;
import static ai.grakn.test.matcher.QueryUtil.tmdbVoteCount;
import static ai.grakn.test.matcher.QueryUtil.variable;
import static ai.grakn.test.matcher.QueryUtil.war;
