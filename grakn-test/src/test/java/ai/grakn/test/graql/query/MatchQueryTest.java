...
import static ai.grakn.test.matcher.GraknMatchers.aRuleType;
import static ai.grakn.test.matcher.GraknMatchers.action;
import static ai.grakn.test.matcher.GraknMatchers.alPacino;
import static ai.grakn.test.matcher.GraknMatchers.allVariables;
import static ai.grakn.test.matcher.GraknMatchers.apocalypseNow;
import static ai.grakn.test.matcher.GraknMatchers.benjaminLWillard;
import static ai.grakn.test.matcher.GraknMatchers.betteMidler;
import static ai.grakn.test.matcher.GraknMatchers.character;
import static ai.grakn.test.matcher.GraknMatchers.chineseCoffee;
import static ai.grakn.test.matcher.GraknMatchers.cluster;
import static ai.grakn.test.matcher.GraknMatchers.comedy;
...
import static ai.grakn.test.matcher.GraknMatchers.crime;
import static ai.grakn.test.matcher.GraknMatchers.drama;
import static ai.grakn.test.matcher.GraknMatchers.entity;
import static ai.grakn.test.matcher.GraknMatchers.family;
import static ai.grakn.test.matcher.GraknMatchers.fantasy;
import static ai.grakn.test.matcher.GraknMatchers.gender;
import static ai.grakn.test.matcher.GraknMatchers.genre;
import static ai.grakn.test.matcher.GraknMatchers.genreOfProduction;
import static ai.grakn.test.matcher.GraknMatchers.godfather;
import static ai.grakn.test.matcher.GraknMatchers.harry;
import static ai.grakn.test.matcher.GraknMatchers.hasTitle;
import static ai.grakn.test.matcher.GraknMatchers.hasType;
import static ai.grakn.test.matcher.GraknMatchers.hasValue;
import static ai.grakn.test.matcher.GraknMatchers.heat;
import static ai.grakn.test.matcher.GraknMatchers.hocusPocus;
...
import static ai.grakn.test.matcher.GraknMatchers.judeLaw;
import static ai.grakn.test.matcher.GraknMatchers.kermitTheFrog;
import static ai.grakn.test.matcher.GraknMatchers.language;
import static ai.grakn.test.matcher.GraknMatchers.marlonBrando;
import static ai.grakn.test.matcher.GraknMatchers.martinSheen;
import static ai.grakn.test.matcher.GraknMatchers.mirandaHeart;
import static ai.grakn.test.matcher.GraknMatchers.missPiggy;
import static ai.grakn.test.matcher.GraknMatchers.movie;
import static ai.grakn.test.matcher.GraknMatchers.movies;
import static ai.grakn.test.matcher.GraknMatchers.musical;
import static ai.grakn.test.matcher.GraknMatchers.name;
import static ai.grakn.test.matcher.GraknMatchers.neilMcCauley;
import static ai.grakn.test.matcher.GraknMatchers.person;
import static ai.grakn.test.matcher.GraknMatchers.production;
import static ai.grakn.test.matcher.GraknMatchers.realName;
import static ai.grakn.test.matcher.GraknMatchers.releaseDate;
import static ai.grakn.test.matcher.GraknMatchers.resource;
import static ai.grakn.test.matcher.GraknMatchers.results;
import static ai.grakn.test.matcher.GraknMatchers.robertDeNiro;
import static ai.grakn.test.matcher.GraknMatchers.rule;
import static ai.grakn.test.matcher.GraknMatchers.runtime;
import static ai.grakn.test.matcher.GraknMatchers.sarah;
import static ai.grakn.test.matcher.GraknMatchers.sarahJessicaParker;
import static ai.grakn.test.matcher.GraknMatchers.spy;
import static ai.grakn.test.matcher.GraknMatchers.theMuppets;
import static ai.grakn.test.matcher.GraknMatchers.title;
import static ai.grakn.test.matcher.GraknMatchers.tmdbVoteAverage;
import static ai.grakn.test.matcher.GraknMatchers.tmdbVoteCount;
import static ai.grakn.test.matcher.GraknMatchers.variable;
import static ai.grakn.test.matcher.GraknMatchers.war;
