...
public class ReasoningTests {
    ...
    @ClassRule
    public static final GraphContextOld testSet1 = GraphContextOld.preLoad("testSet1.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet2 = GraphContextOld.preLoad("testSet2.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet3 = GraphContextOld.preLoad("testSet3.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet4 = GraphContextOld.preLoad("testSet4.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet5 = GraphContextOld.preLoad("testSet5.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet6 = GraphContextOld.preLoad("testSet6.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet7 = GraphContextOld.preLoad("testSet7.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet8 = GraphContextOld.preLoad("testSet8.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet9 = GraphContextOld.preLoad("testSet9.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet10 = GraphContextOld.preLoad("testSet10.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet11 = GraphContextOld.preLoad("testSet11.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet12 = GraphContextOld.preLoad("testSet12.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet13 = GraphContextOld.preLoad("testSet13.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet14 = GraphContextOld.preLoad("testSet14.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet15 = GraphContextOld.preLoad("testSet15.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet16 = GraphContextOld.preLoad("testSet16.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet17 = GraphContextOld.preLoad("testSet17.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet18 = GraphContextOld.preLoad("testSet18.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet19 = GraphContextOld.preLoad("testSet19.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet19recursive = GraphContextOld.preLoad("testSet19-recursive.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet20 = GraphContextOld.preLoad("testSet20.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet21 = GraphContextOld.preLoad("testSet21.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet22 = GraphContextOld.preLoad("testSet22.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet23 = GraphContextOld.preLoad("testSet23.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet24 = GraphContextOld.preLoad("testSet24.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet25 = GraphContextOld.preLoad("testSet25.gql").assumeTrue(GraknTestSetup.usingTinker());

    @ClassRule
    public static final GraphContextOld testSet26 = GraphContextOld.preLoad("testSet26.gql").assumeTrue(GraknTestSetup.usingTinker());
