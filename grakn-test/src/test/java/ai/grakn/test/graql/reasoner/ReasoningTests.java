...
public class ReasoningTests {
    ...
    public void reusingResources2() {
        ...
        QueryAnswers answers2 = queryAnswers(qb.parse(queryString2));
        assertEquals(answers2.size(), 1);
        assertTrue(answers2.iterator().next().get(Graql.varName("x")).isResource());
        ...
        assertTrue(answers3.iterator().next().get(Graql.varName("x")).isResource());
        assertTrue(answers3.iterator().next().get(Graql.varName("y")).isResource());
    }
    ...
    public void reusingResources3() {
        ...
        answers1.forEach(ans ->
                {
                    assertTrue(ans.get(Graql.varName("x")).isEntity());
                    assertTrue(ans.get(Graql.varName("y")).isResource());
                    assertTrue(ans.get(Graql.varName("z")).isRelation());
                }
        );
        ...
        answers2.forEach(ans ->
                {
                    assertTrue(ans.get(Graql.varName("x")).isRelation());
                    assertTrue(ans.get(Graql.varName("y")).isResource());
                }
        );
    }
