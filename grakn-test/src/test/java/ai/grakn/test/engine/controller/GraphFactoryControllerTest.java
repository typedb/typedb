...
public class GraphFactoryControllerTest {
	...
	public void testKeyspaceList() throws GraknValidationException {
		Grakn.session(Grakn.DEFAULT_URI, "grakntest1").open(GraknTransactionType.WRITE).close();
        Grakn.session(Grakn.DEFAULT_URI, "grakntest2").open(GraknTransactionType.WRITE).close();
    ...
    public void testGraknClientBatch() {
        GraknGraph batch = Grakn.session(Grakn.DEFAULT_URI, "grakntestagain").open(GraknTransactionType.BATCH);
        assertTrue(((AbstractGraknGraph) batch).isBatchLoadingEnabled());
    }

    @Test
    public void testGrakn() throws GraknValidationException {
        AbstractGraknGraph graph = (AbstractGraknGraph) Grakn.session(Grakn.DEFAULT_URI, "grakntest").open(GraknTransactionType.WRITE);
        AbstractGraknGraph graph2 = (AbstractGraknGraph) Grakn.session(Grakn.DEFAULT_URI, "grakntest2").open(GraknTransactionType.WRITE);
        ...
        AbstractGraknGraph batch = (AbstractGraknGraph) Grakn.session(Grakn.DEFAULT_URI, "grakntest").open(GraknTransactionType.BATCH);
    ...
    public void testGraphSingleton(){
        ...
        AbstractGraknGraph graphNormal = (AbstractGraknGraph) Grakn.session(Grakn.DEFAULT_URI, keyspace).open(GraknTransactionType.WRITE);
        AbstractGraknGraph graphBatch = (AbstractGraknGraph) Grakn.session(Grakn.DEFAULT_URI, keyspace).open(GraknTransactionType.BATCH);
