...
import static ai.grakn.test.engine.tasks.LongExecutionTestTask.clearCompletedTasks;
import static ai.grakn.test.engine.tasks.LongExecutionTestTask.completedTasks;
