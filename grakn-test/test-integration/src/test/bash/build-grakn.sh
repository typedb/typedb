...
mvn clean install -T 14 --batch-mode -Dmaven.repo.local=${WORKSPACE}/maven -DskipTests -U -Djetty.log.level=WARNING -Dfindbugs.skip=true -Djetty.log.appender=STDOUT
