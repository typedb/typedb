<template>
  <div>
    <button :class="{'disabled':!currentKeyspace, 'btn-selected':toolTipShown === 'typesPanel'}" @click="togglePanel" class="btn types-btn" id="types-panel">
        <span>Types</span>
        <caret-icon :toggleNorth="toolTipShown === 'typesPanel'" style="margin-left:10px;"></caret-icon>
    </button> 
