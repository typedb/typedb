...
goog.exportSymbol('proto.session.Transaction.Query.INFER', null, global);
 ...
 * @enum {number}
 */
proto.session.Transaction.Query.INFER = {
  TRUE: 0,
  FALSE: 1
};
...
proto.session.Transaction.Query.Req.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    infer: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.session.Transaction.Query.Req.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.session.Transaction.Query.INFER} */ (reader.readEnum());
      msg.setInfer(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.session.Transaction.Query.INFER}
 */
proto.session.Transaction.Query.Req.prototype.getInfer = function() {
  return /** @type {!proto.session.Transaction.Query.INFER} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.session.Transaction.Query.INFER} value */
