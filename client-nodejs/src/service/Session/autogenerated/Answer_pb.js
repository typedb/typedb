...
goog.exportSymbol('proto.session.Explanation', null, global);
...
proto.session.QueryAnswer.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    explanation: (f = msg.getExplanation()) && proto.session.Explanation.toObject(includeInstance, f)
  };
...
proto.session.QueryAnswer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.session.Explanation;
      reader.readMessage(value,proto.session.Explanation.deserializeBinaryFromReader);
...
proto.session.QueryAnswer.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.session.Explanation.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Explanation explanation = 2;
 * @return {?proto.session.Explanation}
 */
proto.session.QueryAnswer.prototype.getExplanation = function() {
  return /** @type{?proto.session.Explanation} */ (
    jspb.Message.getWrapperField(this, proto.session.Explanation, 2));
};


/** @param {?proto.session.Explanation|undefined} value */
proto.session.QueryAnswer.prototype.setExplanation = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.session.QueryAnswer.prototype.clearExplanation = function() {
 ...
 * @return {!boolean}
 */
proto.session.QueryAnswer.prototype.hasExplanation = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @constructor
 */
proto.session.Explanation = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.session.Explanation.repeatedFields_, null);
};
goog.inherits(proto.session.Explanation, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.session.Explanation.displayName = 'proto.session.Explanation';
}
/**
 ...
 * @const
 */
proto.session.Explanation.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.session.Explanation.prototype.toObject = function(opt_includeInstance) {
  return proto.session.Explanation.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.session.Explanation} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.session.Explanation.toObject = function(includeInstance, msg) {
  var f, obj = {
    querypattern: jspb.Message.getFieldWithDefault(msg, 1, ""),
    queryanswerList: jspb.Message.toObjectList(msg.getQueryanswerList(),
    proto.session.QueryAnswer.toObject, includeInstance)
  };
 ...
 * @return {!proto.session.Explanation}
 */
proto.session.Explanation.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.session.Explanation;
  return proto.session.Explanation.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.session.Explanation} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.session.Explanation}
 */
proto.session.Explanation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.setQuerypattern(value);
      break;
    case 2:
      var value = new proto.session.QueryAnswer;
      reader.readMessage(value,proto.session.QueryAnswer.deserializeBinaryFromReader);
      msg.addQueryanswer(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.session.Explanation.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.session.Explanation.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.session.Explanation} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.session.Explanation.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getQuerypattern();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string queryPattern = 1;
 * @return {string}
 */
proto.session.Explanation.prototype.getQuerypattern = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.session.Explanation.prototype.setQuerypattern = function(value) {
 ...
 * @return {!Array.<!proto.session.QueryAnswer>}
 */
proto.session.Explanation.prototype.getQueryanswerList = function() {
  return /** @type{!Array.<!proto.session.QueryAnswer>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.session.QueryAnswer, 2));
};


/** @param {!Array.<!proto.session.QueryAnswer>} value */
proto.session.Explanation.prototype.setQueryanswerList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.session.QueryAnswer=} opt_value
 * @param {number=} opt_index
 * @return {!proto.session.QueryAnswer}
 */
proto.session.Explanation.prototype.addQueryanswer = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.session.QueryAnswer, opt_index);
};


proto.session.Explanation.prototype.clearQueryanswerList = function() {
  this.setQueryanswerList([]);
};
