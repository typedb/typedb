...
load(
    "@graknlabs_build_tools_ci_pip//:requirements.bzl",
...
load(
    "@graknlabs_graql//dependencies/maven:dependencies.bzl",
...
###############################
load(
    "@graknlabs_benchmark//dependencies/maven:dependencies.bzl",
...
load(
    "@graknlabs_simulation//dependencies/maven:dependencies.bzl",
