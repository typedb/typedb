...
// ponytail: the query vector may be a literal or a variable (e.g. supplied via `given`);
// the threshold must be a literal. Expression args can be added when a use case appears.
